...
export const SvgSegment = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 844 723.28" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
    ...
    <Path d="M970.22 454.21a124 124 0 00-77.38-138.89l-44.47 115.77z" transform="translate(-178 -88.36)" fill="url(#Segment_svg__c)" />
    ...
    <Path d="M720.82 366.22l92-77.27a120.14 120.14 0 10.45 154z" transform="translate(-178 -88.36)" fill="url(#Segment_svg__d)" />
    ...
    <Path d="M965.82 448.11l.13.43c1.49-.73-.13-.43-.13-.43z" transform="translate(-178 -88.36)" fill="url(#Segment_svg__e)" opacity={0.2} />
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M658.9 378.69s-5.79-4.82 0-13.5 16.39-1.93 16.39-1.93 3.86 12.54 0 15.43-16.39 0-16.39 0z" fill="#ca7070" />
    <Path data-name="&lt;Path&gt;" d="M718.53 701.43h-26.58s.61 3.22-2.51 6.82c-3.58 4.14-10.77 9.13-7.39 10.83h36.48z" fill="#00695c" />
    <Path
      ...
      opacity={0.2}
    />
    <Path data-name="&lt;Path&gt;" d="M813.19 695.95l-24.92 4.07a12.67 12.67 0 01-1.13 8.76c-2.72 5.65-8.82 12.9-5.15 14.45l36-5.82z" fill="#00695c" />
    <Path d="M801 366.91s28.5 89.73-19.23 139.45L768 495.82s28.21-98 12.42-121c27.84-9.25 20.58-7.91 20.58-7.91z" fill="#00695c" />
    <Path d="M781.36 374.84s-5.79-4.82 0-13.5 16.39-1.93 16.39-1.93 3.86 12.54 0 15.43-16.39 0-16.39 0z" fill="#ca7070" />
    <Path
    ...
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M788.6 583.64s-57.66 6.51-59.79 0c-14.95-45.8 0-82 0-82a29.89 29.89 0 0129.89-29.89 29.89 29.89 0 0129.9 29.89z" fill="#00695c" />
    <Path d="M788.6 583.64l26 119.57h-26l-27-88.72s-33.75 14.46-42.43 43.39 0 45.32 0 45.32h-28l-.28-1.3a124.33 124.33 0 0137.92-118.26" fill="#263238" />
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M728.33 501.16s-77.14-54-69.43-122.47h17.36s41.47 89.68 68 98.36-15.93 24.11-15.93 24.11z" fill="#00695c" />
    <G opacity={0.2} fill="#fff">
    ...
    <Path d="M661.79 379.64h-2.89c-7.71 68.47 69.43 122.47 69.43 122.47s.71-.26 1.89-.73c-8.99-6.58-75.63-57.86-68.43-121.74z" fill="#fff" opacity={0.2} />
    <Path
