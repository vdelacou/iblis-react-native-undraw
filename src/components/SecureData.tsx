...
export const SvgSecureData = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 918.14 765.54" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="SecureData_svg__a" x1={397.74} y1={717.25} x2={397.74} y2={86.11} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="SecureData_svg__b" x1={288.88} y1={378.44} x2={288.88} y2={209.65} xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__c" x1={288.88} y1={328.29} x2={288.88} y2={223.1} xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__e" x1={288.88} y1={594.94} x2={288.88} y2={426.14} xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__f" x1={288.88} y1={544.79} x2={288.88} y2={439.6} xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__h" x1={671.57} y1={760.34} x2={671.57} y2={129.2} gradientTransform="rotate(90 651.765 457.665)" xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__i" x1={670.96} y1={553.63} x2={670.96} y2={387.28} gradientTransform="rotate(90 648.96 480.55)" xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__j" x1={637.66} y1={754.12} x2={637.66} y2={601.05} xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__k" x1={778.37} y1={673.86} x2={778.37} y2={569.13} xlinkHref="#SecureData_svg__a" />
      <LinearGradient id="SecureData_svg__l" x1={778.37} y1={774.41} x2={778.37} y2={713.66} xlinkHref="#SecureData_svg__a" />
    ...
    <Path fill="url(#SecureData_svg__a)" d="M162.9 86.11h469.69v631.14H162.9z" opacity={0.5} />
    <Path fill="#f2f2f2" d="M169.02 94.67h455.01v609.12H169.02z" />
    <Path fill="#e0e0e0" d="M204.49 120.36h156.56v4.89H204.49z" />
    <Path fill={props.primarycolor} opacity={0.7} d="M204.49 142.37h156.56v4.89H204.49z" />
    <Path
      fill="#e0e0e0"
    ...
    />
    <Path fill="url(#SecureData_svg__b)" d="M205.71 209.65h166.35v168.79H205.71z" opacity={0.5} />
    <Path fill="#f5f5f5" d="M206.76 213.32h163.72v161.45H206.76z" />
    <Path fill="url(#SecureData_svg__c)" d="M212.53 223.1h152.7v105.19h-152.7z" opacity={0.5} />
    <Path data-name="&lt;Rectangle&gt;" fill="#fff" d="M213.58 224.32h150.6v101.52h-150.6z" />
    <G clipPath="url(#SecureData_svg__d)" fill={props.primarycolor}>
      <Path opacity={0.4} d="M200.82 322.18l37.92-58.72 15.9 25.69 34.24-35.47 29.36 35.47 25.69-52.59 66.05 105.19-214.05-7.34 4.89-12.23z" />
      <Circle cx={230.17} cy={239} r={11.01} opacity={0.4} />
    </G>
    <Path fill="url(#SecureData_svg__e)" d="M205.71 426.14h166.35v168.79H205.71z" opacity={0.5} />
    <Path fill="#f5f5f5" d="M206.76 429.81h163.72v161.45H206.76z" />
    <Path fill="url(#SecureData_svg__f)" d="M212.53 439.6h152.7v105.19h-152.7z" opacity={0.5} />
    <Path data-name="&lt;Rectangle&gt;" fill="#fff" d="M213.58 440.82h150.6v101.52h-150.6z" />
    <G clipPath="url(#SecureData_svg__g)" fill="#bdbdbd">
      <Path opacity={0.4} d="M200.82 538.67l37.92-58.71 15.9 25.69 34.24-35.47 29.36 35.47 25.69-52.6 66.05 105.19-214.05-7.34 4.89-12.23z" />
      <Circle cx={230.17} cy={455.5} r={11.01} opacity={0.4} />
    </G>
    <Path transform="rotate(-78.76 553.216 529.704)" fill="url(#SecureData_svg__h)" d="M349.09 242.63h631.14v469.69H349.09z" opacity={0.5} />
    ...
    />
    <Path fill={props.primarycolor} opacity={0.7} d="M285.074 607.213l91.177 18.12-.953 4.796-91.177-18.12zM380.68 126.144l158.354 31.47-.953 4.796-158.354-31.47z" />
    ...
    <Path transform="rotate(-78.76 547.604 554.776)" fill="url(#SecureData_svg__i)" d="M575.87 357.6h166.35v289.88H575.87z" opacity={0.5} />
    ...
    <Path fill={props.primarycolor} d="M418.862 354.455l34.79 6.914-23.125 116.365-34.79-6.914z" />
    ...
    <Path fill="url(#SecureData_svg__j)" d="M544.42 601.05H730.9v153.07H544.42z" />
    <Path d="M723.82 639a54.55 54.55 0 01109.1 0v34.91h15.27V639a69.82 69.82 0 00-139.65 0v34.91h15.27z" transform="translate(-140.93 -67.23)" fill="url(#SecureData_svg__k)" />
    <Path d="M585.07 571.02a52.37 52.37 0 11104.74 0v33.52h14.66v-33.52a67.03 67.03 0 00-134.06 0v33.52h14.66z" fill="#f5f5f5" />
    <Path fill={props.primarycolor} d="M546.32 602.45h182.24v148.73H546.32z" />
    ...
    />
    <Path d="M648.96 662.15a11.52 11.52 0 10-19.9 7.89v24.58a8.38 8.38 0 1016.76 0v-24.58a11.47 11.47 0 003.14-7.89z" opacity={0.2} />
  </Svg>
);
