...
export const SvgChilling = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 970 781.61" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      ...
      <LinearGradient id="Chilling_svg__b" x1={1718.23} y1={-1648.44} x2={1718.23} y2={-1862.67} gradientTransform="rotate(-18.87 7510.01 3049.535)" xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__c" x1={1731.89} y1={-1787.45} x2={1731.89} y2={-1814.78} gradientTransform="translate(-1271.46 2131.88)" xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__d" x1={1763.79} y1={-1719.1} x2={1763.79} y2={-1746.44} gradientTransform="translate(-1237.95 2101.1)" xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__e" x1={1659} y1={-1746.44} x2={1659} y2={-1773.78} gradientTransform="translate(-1234.6 2166.35)" xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__f" x1={1686.33} y1={-1678.1} x2={1686.33} y2={-1705.44} gradientTransform="translate(-1200.26 2138.19)" xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__g" x1={752.69} y1={339.56} x2={752.69} y2={202.23} xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__h" x1={676.63} y1={422.03} x2={676.63} y2={186.54} xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__i" x1={670.37} y1={305.53} x2={670.37} y2={295.41} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="#fff" />
        <Stop offset={1} />
      </LinearGradient>
      <LinearGradient id="Chilling_svg__j" x1={612.66} y1={683.48} x2={612.66} y2={59.2} xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__k" x1={1186.13} y1={-329.85} x2={1186.13} y2={-425.03} gradientTransform="translate(-521.72 1157.6)" xlinkHref="#Chilling_svg__a" />
      <LinearGradient id="Chilling_svg__l" x1={1083.07} y1={-358.53} x2={1083.07} y2={-539.81} gradientTransform="rotate(-18.54 4471.565 1799.515)" xlinkHref="#Chilling_svg__a" />
    </Defs>
    <Path
      ...
      opacity={0.5}
    />
    <Path fill={props.primarycolor} d="M68.12 537.67h54.67v68.34H68.12zM738.37 538.18h54.67v68.34h-54.67zM838.6 537.67h54.67v68.34H838.6zM191.64 538.18h54.67v68.34h-54.67z" />
    <Path opacity={0.3} d="M68.12 537.67h54.67v68.34H68.12zM738.37 538.18h54.67v68.34h-54.67zM838.6 537.67h54.67v68.34H838.6zM191.64 538.18h54.67v68.34h-54.67z" />
    <Path d="M765.2 200.52h137.54A49.26 49.26 0 01952 249.78v252.69a48.87 48.87 0 01-48.87 48.87H765.2V200.52z" fill={props.primarycolor} />
    <Path d="M765.2 200.52h137.54A49.26 49.26 0 01952 249.78v252.69a48.87 48.87 0 01-48.87 48.87H765.2V200.52z" opacity={0.3} />
    ...
    />
    <Rect x={382.64} y={278.19} width={185.66} height={195.43} rx={57.05} ry={57.05} transform="rotate(-16.25 210.548 748.998)" fill="url(#Chilling_svg__b)" />
    <Rect x={385.59} y={287.11} width={173.13} height={182.24} rx={53.2} ry={53.2} transform="rotate(-16.25 207.216 751.31)" fill="#f55f44" />
    <Rect x={385.59} y={287.11} width={173.13} height={182.24} rx={53.2} ry={53.2} transform="rotate(-16.25 207.216 751.31)" opacity={0.1} />
    <Rect x={388.9} y={284.78} width={173.13} height={182.24} rx={53.2} ry={53.2} transform="rotate(-16.25 210.548 748.998)" fill="#f55f44" />
    ...
    <Path d="M72.13 200.52h201v350.82h-201A54.13 54.13 0 0118 497.22V254.65a54.13 54.13 0 0154.13-54.13z" fill={props.primarycolor} />
    <Path d="M72.51 200.52H222.7A50.44 50.44 0 01273.14 251v249.9a50.44 50.44 0 01-50.44 50.44H72.51A54.51 54.51 0 0118 496.83V255a54.51 54.51 0 0154.51-54.48z" opacity={0.3} />
    ...
    <Path d="M416.45 177.87l51.82-60a10.9 10.9 0 00-.82-15.11L354.69 17.3 341 38.66l87.39 67.27-37.1 40.68z" fill="#fda57d" />
    <Path d="M410.5 125.62l-18.13 19.88 25.19 31.3 26-30.06a75.76 75.76 0 01-33.06-21.12z" opacity={0.1} />
    <Path d="M266 190.89l-58.67-44a17.83 17.83 0 01-4.39-23.76l87.79-97.69 18 18L248 119.09l35.9 35.9z" fill="#fda57d" />
    ...
    <Path d="M317.32 329.24l17.35 34.71a57.54 57.54 0 0059.61 31.23l210.26-30 71.81 89.76 53.85-53.85-115.85-99.3a29.22 29.22 0 00-22.64-6.81z" fill="#4d8af0" />
    <Path
    ...
    <Path
      ...
      fill="#3ad29f"
    />
    <Path d="M308.52 114.16v20a38.3 38.3 0 0011.22 27.08l42.64 42.64 14.19-28.39a35.6 35.6 0 003.76-15.92v-45.41z" fill="#fda57d" />
    ...
    <Path opacity={0.1} d="M283.68 207.93l2.5-7.49 7.48 4.99-9.98 2.5zM445.55 244.8s-27.16 13-34.65 25.5M433.35 163.03l-2.49 7.48-4.99-7.48h7.48z" />
    <Path
      d="M308.52 78.54h89.76s35.9-35.9 0-53.85a122.89 122.89 0 00-24.36-8.6c-54.59-13.84-106.5 31.31-99.48 87.19 1.66 13.2 6.39 24 16.13 29.11 37.89 19.95 17.95-53.85 17.95-53.85z"
      fill="#333"
    />
    <Path d="M550 280.16s18.21 39.59-5.7 43-13-33.16-13-33.16-2.39-10.85-8.21-11.46M572 279.2s-21.65 37.82 1.86 43.3 15.89-31.87 15.89-31.87 3.34-10.59 9.2-10.69" opacity={0.1} />
    <Path
    ...
    />
    <Circle cx={664.4} cy={780.16} r={47.59} transform="rotate(-18.54 425.67 1102.95)" fill="url(#Chilling_svg__k)" opacity={0.5} />
