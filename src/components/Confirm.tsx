...
export const SvgConfirm = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 870.553 714.568" style={props.style} width="100%" height={props.height} {...props}>
    <Path d="M650 325c244.268 256.65 448.558 512.646-325 325C150.566 607.687 0 504.493 0 325S145.507 0 325 0s201.254 194.982 325 325z" fill={props.accentcolor} />
    <Path
    ...
    />
    <Path fill="#33ae84" d="M259.67 425.87l-8.926-8.927 2.608-2.607 5.826 5.825 16.256-23.102 3.017 2.124-18.781 26.687z" />
    <Path
    ...
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M759.358 504.774c23.33 14.037 32.316 41.918 32.316 41.918s-28.841 5.123-52.173-8.914-32.316-41.918-32.316-41.918 28.841-5.123 52.173 8.914z" fill="#d0cde1" />
    <Path d="M461.5 188.5l-4 26-18 70s-23 30-3 36 17-35 17-35l25-50v-45zM533.5 467.5l9 17-21 11-8-16 20-12z" fill="#a0616a" />
    ...
    <Path d="M536 98s-21.512 23.939-40.506 10.22c0 0-35.994 16.28-34.994 35.28s15 49 15 49l-3 66s-34 43-12 45 68-1 92-32c0 0 23 6 23-4v-64l8-88z" fill="#d0cde1" />
