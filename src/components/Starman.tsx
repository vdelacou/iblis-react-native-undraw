...
export const SvgStarman = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 829 744.16" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Starman_svg__a" x1={382.9} y1={692.59} x2={382.9} y2={45.25} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="Starman_svg__b" x1={577.21} y1={539.76} x2={577.21} y2={383.34} xlinkHref="#Starman_svg__a" />
      <LinearGradient id="Starman_svg__c" x1={422.99} y1={586.26} x2={422.99} y2={284.95} xlinkHref="#Starman_svg__a" />
      <LinearGradient id="Starman_svg__d" x1={809.48} y1={657.06} x2={809.48} y2={582.42} xlinkHref="#Starman_svg__a" />
      <LinearGradient id="Starman_svg__e" x1={728.61} y1={677.75} x2={728.61} y2={553.95} gradientTransform="rotate(-62.55 694.585 659.015)" xlinkHref="#Starman_svg__a" />
    </Defs>
    <Circle cx={382.9} cy={368.92} r={323.67} fill="url(#Starman_svg__a)" />
    ...
    <Path
      ...
      transform="translate(-185 -76.87)"
      fill="url(#Starman_svg__d)"
    />
    <Path d="M686 503.82c16 21.1 22 38.75 15.73 51-14.39 28.13-56.6 31-157.76-3.8" fill="none" stroke="#bdbdbd" strokeMiterlimit={10} strokeWidth={3} />
    ...
    <Path
      ...
      transform="translate(-185 -76.87)"
      fill="url(#Starman_svg__e)"
    />
    <Path fill="#4f617d" d="M468.372 553.8l26.423-50.867 25.433 13.212-26.423 50.866z" />
    <Path d="M539 558.01v-.09c-8.21 15.8-19.62 26.25-34.67 18.44l-12.11-6.29L522 512.84l12.1 6.29c15.05 7.82 13.11 23.08 4.9 38.88z" fill="#ff656a" />
    <Path
    ...
    <Path
      ...
      fill="#ff6469"
    />
    <Path d="M488.65 495.41l-29.72 57.23-15-7.77c-16.53-8.59-16.44-24.81-8.24-40.61 8.21-15.8 21.43-25.2 38-16.62z" fill="#ff656a" />
