...
export const SvgToTheStars = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 925.18 770.09" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="ToTheStars_svg__b" x1={580.55} y1={759} x2={580.55} y2={113} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="ToTheStars_svg__a" x1={345.9} y1={617.2} x2={345.9} y2={679.83} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="#e0e0e0" />
        <Stop offset={0.31} stopColor="#fccc63" />
        <Stop offset={0.77} stopColor="#f55f44" />
      </LinearGradient>
      <LinearGradient id="ToTheStars_svg__d" x1={420.89} y1={617.2} x2={420.89} y2={679.83} xlinkHref="#ToTheStars_svg__a" />
      <LinearGradient id="ToTheStars_svg__e" x1={467.86} y1={617.2} x2={467.86} y2={679.83} xlinkHref="#ToTheStars_svg__a" />
      <LinearGradient id="ToTheStars_svg__f" x1={543.67} y1={617.2} x2={543.67} y2={679.83} xlinkHref="#ToTheStars_svg__a" />
      <LinearGradient id="ToTheStars_svg__g" x1={580.55} y1={835.05} x2={580.55} y2={647.79} xlinkHref="#ToTheStars_svg__b" />
      <LinearGradient id="ToTheStars_svg__c" x1={272.71} y1={586.52} x2={272.71} y2={732.18} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="#f2f2f2" />
        <Stop offset={0.31} stopColor="#e6e6e6" />
        <Stop offset={0.77} stopColor="#ccc" />
      </LinearGradient>
      <LinearGradient id="ToTheStars_svg__h" x1={272.35} y1={606.91} x2={272.35} y2={766.41} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__i" x1={596.45} y1={606.91} x2={596.45} y2={766.41} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__j" x1={592.44} y1={620.75} x2={592.44} y2={766.41} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__k" x1={574.72} y1={699.54} x2={574.72} y2={831.37} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__l" x1={482.23} y1={737.41} x2={482.23} y2={831.37} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__m" x1={665.03} y1={751.98} x2={665.03} y2={831.37} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__n" x1={802.69} y1={737.41} x2={802.69} y2={831.37} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__o" x1={358.41} y1={737.41} x2={358.41} y2={831.37} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__p" x1={710.43} y1={616.63} x2={710.43} y2={589.91} xlinkHref="#ToTheStars_svg__b" />
      <LinearGradient id="ToTheStars_svg__q" x1={710.43} y1={590.89} x2={710.43} y2={615.65} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__r" x1={771.61} y1={746.75} x2={771.61} y2={717.62} xlinkHref="#ToTheStars_svg__b" />
      <LinearGradient id="ToTheStars_svg__s" x1={771.61} y1={718.34} x2={771.61} y2={746.02} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="#f2f2f2" />
        <Stop offset={0.31} stopColor="#e0e0e0" />
        <Stop offset={0.77} stopColor="#b3b3b3" />
      </LinearGradient>
      <LinearGradient id="ToTheStars_svg__t" x1={148.17} y1={665.16} x2={148.17} y2={633.14} xlinkHref="#ToTheStars_svg__b" />
      <LinearGradient id="ToTheStars_svg__u" x1={148.17} y1={633.86} x2={148.17} y2={664.45} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__v" x1={853.67} y1={152.79} x2={853.67} y2={64.95} xlinkHref="#ToTheStars_svg__b" />
      <LinearGradient id="ToTheStars_svg__w" x1={771.61} y1={718.34} x2={771.61} y2={746.02} xlinkHref="#ToTheStars_svg__c" />
      <LinearGradient id="ToTheStars_svg__x" x1={389.67} y1={446.79} x2={389.67} y2={404.95} xlinkHref="#ToTheStars_svg__b" />
    </Defs>
    <Path
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path fill="url(#ToTheStars_svg__a)" d="M334.37 617.2h23.07v62.62h-23.07z" />
    <Path fill="url(#ToTheStars_svg__d)" d="M409.35 617.2h23.07v62.62h-23.07z" />
    <Path fill="url(#ToTheStars_svg__e)" d="M456.32 617.2h23.07v62.62h-23.07z" />
    <Path fill="url(#ToTheStars_svg__f)" d="M532.13 617.2h23.07v62.62h-23.07z" />
    <Path
      ...
      fill="#eee"
    />
    <Rect x={414.23} y={99.83} width={54.31} height={24.89} rx={11} ry={11} fill={props.primarycolor} />
    <Path
      ...
      opacity={0.7}
    />
    <Circle cx={272.71} cy={659.35} r={72.83} fill="url(#ToTheStars_svg__c)" />
    <Circle cx={272.35} cy={686.66} r={79.75} fill="url(#ToTheStars_svg__h)" />
    <Circle cx={596.45} cy={686.66} r={79.75} fill="url(#ToTheStars_svg__i)" />
    <Circle cx={592.44} cy={693.58} r={72.83} fill="url(#ToTheStars_svg__j)" />
    <Path d="M647.55 772.37a72.7 72.7 0 01-30.12 59H532a72.86 72.86 0 11115.54-59z" transform="translate(-137.41 -64.95)" fill="url(#ToTheStars_svg__k)" />
    <Path
    ...
    />
    <Circle cx={710.43} cy={603.27} r={13.36} fill="url(#ToTheStars_svg__p)" opacity={0.7} />
    <Circle cx={710.43} cy={603.27} r={12.38} fill="url(#ToTheStars_svg__q)" />
    <Circle cx={771.61} cy={732.18} r={14.57} fill="url(#ToTheStars_svg__r)" opacity={0.7} />
    <Circle cx={771.61} cy={732.18} r={13.84} fill="url(#ToTheStars_svg__s)" />
    <Circle cx={148.17} cy={649.15} r={16.01} fill="url(#ToTheStars_svg__t)" opacity={0.7} />
    <Circle cx={148.17} cy={649.15} r={15.29} fill="url(#ToTheStars_svg__u)" />
    <Path
    ...
    />
    <Circle cx={771.61} cy={732.18} r={13.84} fill="url(#ToTheStars_svg__w)" />
    <Path
      ...
      opacity={0.4}
    />
    <Path d="M272.03 360.92a19.77 19.77 0 01-18.52 19.73h-1.25a19.77 19.77 0 119.89-36.9 20 20 0 015.89 5.21 19.67 19.67 0 013.99 11.96z" fill={props.primarycolor} opacity={0.2} />
    <Path
    ...
    <Path d="M268.04 349.05a5.2 5.2 0 11-5.89-5.22 20 20 0 015.89 5.22zM268.43 372.31a19.72 19.72 0 01-14.91 8.35v-.83a9.37 9.37 0 0115-7.52z" fill="#f55f44" opacity={0.1} />
