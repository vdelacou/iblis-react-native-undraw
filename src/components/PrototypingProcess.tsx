...
export const SvgPrototypingProcess = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1110.46 857.68" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="PrototypingProcess_svg__a" x1={2277.26} y1={874.51} x2={2277.26} y2={331.66} gradientTransform="translate(-1992)" gradientUnits="userSpaceOnUse">
    ...
    <Path d="M768.46 115.16a8.05 8.05 0 11-8.05 8.05 8.06 8.06 0 018.05-8.05m0-1a9.05 9.05 0 109 9.05 9 9 0 00-9-9.05z" fill="#fff" />
    <Rect x={575.56} y={302.51} width={88.21} height={119.92} rx={4.3} fill="#fff" stroke="#fff" strokeMiterlimit={10} />
    ...
    <Rect x={724.69} y={302.51} width={88.21} height={119.92} rx={4.3} fill="#fff" stroke="#fff" strokeMiterlimit={10} />
    ...
    <Rect x={873.15} y={217.32} width={88.21} height={119.92} rx={4.3} fill="#fff" stroke="#fff" strokeMiterlimit={10} />
    ...
    <Path
      ...
      strokeWidth={3}
    />
    <Path d="M451.15 479.42s8.35 3.52 8.92 4.91-5.12 9.42-5.12 9.42M437.93 509.27s13.55 5.75 15.6 7.59" fill="none" stroke="#33313f" strokeMiterlimit={10} strokeWidth={3} />
    <Path d="M456.99 509.73s3 8.57 2.3 9.93-10.43 2.48-10.43 2.48" fill="none" stroke="#33313f" strokeMiterlimit={10} strokeWidth={3} />
    <Path
    ...
    <Path fill="#65617d" d="M286.7 585.94l3.56-4.57.79-.82 10.9-11.42 3.71-3.88 1.74-.21 2.5-2.48 1.47 1.29-2.43 2.84.04 1.49-3.79 4.11-10.7 11.62-.69.74-4.3 3.98-2.8-2.69z" />
    ...
    />
    <Path d="M210.47 810.84l-3 9 9.79 9.79 32.39 7.53L273 834.9l-1.51-8.29a10 10 0 00-7.42-7.29c-9.6-2.26-27.9-7.4-31.75-14.55z" fill="#db8b8b" />
    <Path d="M210.47 810.84l-3 9 9.79 9.79 32.39 7.53L273 834.9l-1.51-8.29a10 10 0 00-7.42-7.29c-9.6-2.26-27.9-7.4-31.75-14.55z" opacity={0.1} />
    <Path d="M265.46 832.64l-4.52-6 4.52-7s13.55 5.47 19.58 4.72 9 9.79-2.26 12.8-75.32 0-75.32 0-11.3-5.27 0-19.58l9.79 7.53s16.57 9 24.86 7.53z" fill="#2e3037" />
    <Path
      ...
      fill="#db8b8b"
    />
    <Path d="M285.79 845.45l-23.35 2.26-32.39-7.54-9.82-9.79.8-2.39 9 6.91s16.58 9 24.86 7.53h23.34l-4.52-6 4.06-6.27a9.92 9.92 0 016.49 7z" opacity={0.1} />
    <Path d="M278.23 843.19l-4.52-6 4.52-7s13.56 5.47 19.58 4.72 9 9.79-2.25 12.81-75.33 0-75.33 0-11.3-5.28 0-19.59l9.79 7.53s16.58 9 24.86 7.54z" fill="#2e3037" />
    <Path
      ...
      fill="#db8b8b"
    />
    <Path d="M197.67 578.05s.75 32.39 8.28 48.21l1.51 45.94s-2.26 42.19-6.78 50.47 9.79 78.34 9.79 78.34v12.05s24.1 9 30.88-1.51l-6.78-89.63 3-124.28z" fill="#35323e" />
    <Path d="M197.66 578.05s.75 32.39 8.28 48.21l1.51 45.94s-2.26 42.19-6.78 50.47 9.79 78.34 9.79 78.34v12.05s24.1 9 30.88-1.51l-6.78-89.63 3-124.28z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      fill="#35323e"
    />
    <Path d="M257.17 371.67a42.32 42.32 0 00-4.59 10.88 29.42 29.42 0 01-22.92-.83 36.91 36.91 0 00-6.38-15.32z" opacity={0.1} />
    <Circle cx={242.11} cy={353.59} r={29.38} fill="#db8b8b" />
    <Path d="M279.77 558.47l-.33.06c-31.58 6.49-71.21-26.42-71.21-26.42a38 38 0 002.74-5.61c1.1-1.72 1.78-2.68 1.78-2.68l66.48 26.38.17 2.63z" opacity={0.1} />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M273.74 559.22s15.82 3 23.35 15.07a46.86 46.86 0 007.89 9.85 6 6 0 01-.94 9.52c-6 3.6-15.72 5.81-28-4.31-21.13-17.32-2.3-30.13-2.3-30.13z" fill="#db8b8b" />
    <Path
    ...
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M264.33 445.84s1.5 23.35-5.28 36.16-6.78 29.37 0 38.41M268.09 417.24s-6-6-23.35-6.78-24.85-6-24.85-6" opacity={0.1} />
    <Path
