...
export const SvgNerd = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 742.91 774.18" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
    ...
    <Path d="M375.3 249.82c0 6.77-11.59 12.26-25.89 12.26s-25.89-5.49-25.89-12.26 11.59-12.27 25.89-12.27 25.89 5.45 25.89 12.27z" fill="#fff" />
    ...
    <Rect x={372.7} y={232.8} width={34.06} height={81.76} rx={12} ry={12} transform="rotate(-180 277.935 235.175)" fill="#ffd9cb" />
    <Path
      data-name="&lt;Clipping Path&gt;"
