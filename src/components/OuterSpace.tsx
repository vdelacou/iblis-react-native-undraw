...
export const SvgOuterSpace = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1135.18 814.22" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="OuterSpace_svg__a" x1={277.46} y1={697.11} x2={277.46} y2={669.52} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="OuterSpace_svg__c" x1={748.15} y1={567.16} x2={748.15} y2={544.13} xlinkHref="#OuterSpace_svg__a" />
      <LinearGradient id="OuterSpace_svg__d" x1={556.93} y1={707.16} x2={556.93} y2={42.89} xlinkHref="#OuterSpace_svg__a" />
      <LinearGradient id="OuterSpace_svg__b" x1={456.95} y1={628.14} x2={456.95} y2={692.54} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="#e0e0e0" />
        <Stop offset={0.31} stopColor="#fccc63" />
        <Stop offset={0.77} stopColor="#f55f44" />
      </LinearGradient>
      <LinearGradient id="OuterSpace_svg__e" x1={534.05} y1={628.14} x2={534.05} y2={692.54} xlinkHref="#OuterSpace_svg__b" />
      <LinearGradient id="OuterSpace_svg__f" x1={582.35} y1={628.14} x2={582.35} y2={692.54} xlinkHref="#OuterSpace_svg__b" />
      <LinearGradient id="OuterSpace_svg__g" x1={660.3} y1={628.14} x2={660.3} y2={692.54} xlinkHref="#OuterSpace_svg__b" />
      <LinearGradient id="OuterSpace_svg__h" x1={766.05} y1={409.23} x2={766.05} y2={340.57} xlinkHref="#OuterSpace_svg__a" />
      <LinearGradient id="OuterSpace_svg__i" x1={331.05} y1={577.85} x2={331.05} y2={529.94} xlinkHref="#OuterSpace_svg__a" />
    </Defs>
    <Path
    ...
    />
    <Circle cx={277.46} cy={683.31} r={13.8} fill="url(#OuterSpace_svg__a)" opacity={0.7} />
    ...
    />
    <Circle cx={748.15} cy={555.65} r={11.52} fill="url(#OuterSpace_svg__c)" opacity={0.7} />
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M457.27 692.54h-.65A11.54 11.54 0 01445.08 681v-52.86h23.73V681a11.54 11.54 0 01-11.54 11.54z" transform="translate(-32.41 -42.89)" fill="url(#OuterSpace_svg__b)" />
    <Path d="M534.38 692.54h-.66A11.54 11.54 0 01522.19 681v-52.86h23.72V681a11.54 11.54 0 01-11.53 11.54z" transform="translate(-32.41 -42.89)" fill="url(#OuterSpace_svg__e)" />
    <Path d="M582.67 692.54H582A11.54 11.54 0 01570.49 681v-52.86h23.72V681a11.54 11.54 0 01-11.54 11.54z" transform="translate(-32.41 -42.89)" fill="url(#OuterSpace_svg__f)" />
    <Path d="M660.63 692.54H660A11.54 11.54 0 01648.44 681v-52.86h23.72V681a11.54 11.54 0 01-11.53 11.54z" transform="translate(-32.41 -42.89)" fill="url(#OuterSpace_svg__g)" />
    <Path
