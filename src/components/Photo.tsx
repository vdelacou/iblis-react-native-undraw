...
export const SvgPhoto = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 887.82 625.36" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
    ...
    />
    <Path d="M862.73 579.56a18.52 18.52 0 01-18.52 18.52H29.47a18.52 18.52 0 01-18.52-18.52V28.8a18.52 18.52 0 0118.52-18.52h814.74a18.52 18.52 0 0118.52 18.52" fill="#fff" />
    <Rect x={43.49} y={36.62} width={787.52} height={537.89} rx={8.85} ry={8.85} fill="url(#Photo_svg__b)" data-name="&lt;Rectangle&gt;" />
