...
export const SvgContainerShip = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 932.375 646.22" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="ContainerShip_svg__a" x1={401.199} y1={238.812} x2={401.199} y2={191.492} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.535} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="ContainerShip_svg__b" x1={548.199} y1={175.413} x2={548.199} y2={144.89} xlinkHref="#ContainerShip_svg__a" />
      <LinearGradient id="ContainerShip_svg__c" x1={819.199} y1={155.413} x2={819.199} y2={124.89} xlinkHref="#ContainerShip_svg__a" />
      <LinearGradient id="ContainerShip_svg__d" x1={138.375} y1={143.683} x2={138.375} y2={9.683} xlinkHref="#ContainerShip_svg__a" />
    </Defs>
    ...
    <Circle cx={177.688} cy={162.61} r={21} fill={props.primarycolor} stroke={props.primarycolor} strokeMiterlimit={10} />
    <Path
