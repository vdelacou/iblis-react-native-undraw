...
export const SvgPhotoSession = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 993 742" style={props.style} width="100%" height={props.height} {...props}>
    <Path
      ...
      fill="#f0f0f0"
    />
    <Path d="M613.733 318.706l-22.927-6.384s-8.981-1.793-3.494-19.332 16.371-12.63 16.371-12.63l20.34 5.908 8.03 2.48-11.299 15.851-.947 10.565z" fill={props.accentcolor} />
    <Path
    ...
    />
    <Ellipse cx={744.606} cy={351} rx={3.049} ry={2.069} transform="rotate(-14.057 372.461 731.258)" fill={props.primarycolor} />
    <Ellipse cx={721.322} cy={381.751} rx={3.049} ry={2.069} transform="rotate(-14.057 349.177 762.01)" fill={props.primarycolor} />
    <Path d="M598.5 354.5l5-17s-13-31 2-34 16 29 16 29l-6 19z" fill="#ffb6b6" />
    <Circle cx={691.332} cy={281.723} r={39.723} fill="#ffb6b6" />
    <Path d="M678.48 309.762s-2.336 29.208-8.178 31.545S733.392 360 733.392 360l-17.526-19.861s-3.505-30.377 4.674-37.387z" fill="#ffb6b6" />
    ...
    />
    <Path d="M541.5 490.5s-7-1-6 16 4 78 9 90 6 26 4 31-6 13 1 14 36-3 39-4 6-18 4-18-7-1-5-8 3-7 0-9-11-5-9-7 4-49 4-49z" fill={props.haircolor} />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Ellipse cx={802.056} cy={302.901} rx={1.655} ry={4.375} transform="rotate(-80.315 703.493 324.731)" fill={props.haircolor} />
