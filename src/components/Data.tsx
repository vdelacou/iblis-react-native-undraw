...
export const SvgData = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 891 711.05" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Data_svg__a" x1={213.62} y1={486} x2={213.62} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="Data_svg__b" x1={227.62} y1={373} x2={227.62} y2={362} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__c" x1={227.62} y1={429} x2={227.62} y2={418} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__d" x1={329.62} y1={429} x2={329.62} y2={418} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__e" x1={336.62} y1={83} x2={336.62} y2={72} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__f" x1={336.62} y1={98} x2={336.62} y2={87} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__g" x1={336.62} y1={113} x2={336.62} y2={102} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__h" x1={336.62} y1={128} x2={336.62} y2={117} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__i" x1={214.12} y1={332} x2={214.12} y2={182} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__j" x1={383.9} y1={435.3} x2={383.9} y2={283.3} gradientTransform="translate(-5.78 .18)" xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__k" x1={442.9} y1={321.3} x2={442.9} y2={307.3} gradientTransform="translate(-10.11 -4.98)" xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__l" x1={484.9} y1={317.3} x2={484.9} y2={303.3} gradientTransform="translate(-10.64 -8.78)" xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__m" x1={547.96} y1={413.42} x2={547.96} y2={413.16} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__n" x1={517.63} y1={581.29} x2={517.63} y2={408.48} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__o" x1={191.31} y1={423.33} x2={191.31} y2={423.02} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__p" x1={228.23} y1={619.83} x2={228.23} y2={417.36} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__q" x1={692} y1={659.05} x2={692} y2={163.05} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__r" x1={595.12} y1={395.68} x2={595.12} y2={241.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__s" x1={788.12} y1={472.68} x2={788.12} y2={318.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__t" x1={696.12} y1={614.68} x2={696.12} y2={508.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__u" x1={749.12} y1={475.15} x2={749.12} y2={351.15} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__v" x1={790.62} y1={362.68} x2={790.62} y2={344.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__w" x1={760.62} y1={699.68} x2={760.62} y2={677.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__x" x1={607.62} y1={687.68} x2={607.62} y2={566.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__y" x1={608.62} y1={648.68} x2={608.62} y2={648.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__z" x1={482.12} y1={645.68} x2={482.12} y2={590.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__A" x1={459.62} y1={699.68} x2={459.62} y2={677.68} xlinkHref="#Data_svg__a" />
      <LinearGradient id="Data_svg__B" x1={486.35} y1={708.79} x2={600.65} y2={708.79} xlinkHref="#Data_svg__a" />
    </Defs>
    ...
    <Path fill={props.primarycolor} opacity={0.5} d="M33.62 363h149v9h-149z" />
    ...
    <Path fill={props.primarycolor} d="M204.62 363h47v9h-47zM204.62 419h47v9h-47zM305.62 419h47v9h-47z" />
    <Path fill="#f5f5f5" d="M33.62 391h149v9h-149z" />
    <Path fill={props.primarycolor} opacity={0.5} d="M204.62 391h149v9h-149z" />
    <Path fill="#f5f5f5" d="M204.62 447h149v9h-149z" />
    <Path fill={props.primarycolor} opacity={0.5} d="M33.62 419h149v9h-149z" />
    <Path fill="#f5f5f5" d="M33.62 447h149v9h-149zM139.62 88h84v9h-84zM238.62 88h29v9h-29zM139.62 118h84v9h-84zM238.62 118h29v9h-29zM139.62 103h149v9h-149z" />
    <Path fill={props.primarycolor} d="M243.62 36h149v9h-149z" opacity={0.2} />
    ...
    <Path fill={props.primarycolor} opacity={0.5} d="M33.62 185h359v142h-359z" />
    <Path fill="#fff" opacity={0.5} d="M44.62 196h348v-11h-359v142h11V196z" />
    <Path transform="rotate(-5.2 -739.107 2013.604)" fill="url(#Data_svg__j)" d="M193.12 283.48h370v152h-370z" />
    <Path fill="#fff" d="M38.811 209.538l357.523-32.537 12.87 141.416L51.68 350.954z" />
    <Path d="M65.5 325.59l-6.2-78.77s32-34 96.6-8.8 95.06 7.41 105.56-9.61 65-36 82.66-7.53 38.84-3.54 38.84-3.54l7.16 78.67z" fill={props.primarycolor} opacity={0.5} />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} d="M98.03 229.66l.54 5.98" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} strokeDasharray="11.51 11.51" d="M99.62 247.1l5.74 63.06" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} d="M105.88 315.89l.55 5.97M159.52 239.42l.55 5.97" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} strokeDasharray="13.06 13.06" d="M161.25 258.4l4.15 45.51" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} d="M165.99 310.41l.54 5.98M222.26 250.1l.6 5.97" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} strokeDasharray="9.79 9.79" d="M223.83 265.82l3.38 34.1" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} d="M227.7 304.79l.59 5.98M278.65 214.84l.54 5.98" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} strokeDasharray="11.28 11.28" d="M280.21 232.05l5.63 61.79" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} d="M286.35 299.45l.55 5.98M319.35 206.59l.54 5.97" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} strokeDasharray="11.93 11.93" d="M320.97 224.44l5.95 65.33" />
    <Path fill="none" stroke={props.primarycolor} strokeMiterlimit={10} d="M327.46 295.71l.55 5.97" />
    ...
    <Circle cx={432.8} cy={309.31} r={7} transform="rotate(-5.2 -684.42 1963.457)" fill="url(#Data_svg__k)" />
    <Circle cx={474.26} cy={301.52} r={7} transform="rotate(-5.2 -642.91 1955.633)" fill="url(#Data_svg__l)" />
    <Circle cx={432.8} cy={309.31} r={5} transform="rotate(-5.2 -684.42 1963.457)" fill={props.primarycolor} />
    <Circle cx={474.26} cy={301.52} r={5} transform="rotate(-5.2 -642.91 1955.633)" fill={props.primarycolor} />
    <Circle cx={537.64} cy={313.82} r={5} transform="rotate(-5.2 -579.477 1968.002)" fill="#69f0ae" />
    <Path d="M547.76 413.2l.07.23c.77-.43-.07-.23-.07-.23z" transform="translate(-154.5 -94.48)" fill="url(#Data_svg__m)" opacity={0.2} />
    <Path
    ...
    <Path data-name="&lt;Path&gt;" d="M357.04 497.27h-13.89a4.56 4.56 0 01-1.31 3.57c-1.87 2.16-5.63 4.77-3.86 5.66h19.06z" fill="#00695c" />
    <Path d="M342.85 500.84a4.56 4.56 0 001.31-3.57h-1a4.56 4.56 0 01-1.31 3.57c-1.87 2.16-5.63 4.77-3.86 5.66h1c-1.77-.89 1.99-3.49 3.86-5.66z" fill="#fff" opacity={0.2} />
    <Path data-name="&lt;Path&gt;" d="M406.5 494.41l-13 2.11a6.62 6.62 0 01-.59 4.58c-1.42 3-4.61 6.74-2.69 7.55l18.82-3z" fill="#00695c" />
    <Path d="M400.16 322.46s14.87 46.91-10.07 72.88l-7.2-5.51s14.74-51.2 6.49-63.22c14.56-4.85 10.78-4.15 10.78-4.15z" fill="#00695c" />
    ...
    <Path d="M383.9 392.85s14.56-50.57 6.63-63c-.7-.13-1.15-.23-1.15-.23l-.13-.12-.37.12c8.25 12-6.49 63.22-6.49 63.22l7.2 5.51.63-.68z" fill="#fff" opacity={0.2} />
    ...
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M393.66 435.7s-30.13 3.4-31.24 0c-7.81-23.94 0-42.83 0-42.83a15.62 15.62 0 0115.62-15.62 15.62 15.62 0 0115.62 15.62z" fill="#00695c" />
    <Path d="M393.66 435.7l13.61 62.49h-13.61l-14.11-46.36s-17.64 7.56-22.17 22.68 0 23.68 0 23.68h-14.62l-.15-.68a65 65 0 0119.8-61.81" fill="#263238" />
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M362.17 392.61s-40.31-28.22-36.28-64h9.07s21.66 46.91 35.54 51.41-8.33 12.59-8.33 12.59z" fill="#00695c" />
    ...
    <Path d="M327.4 329.12h-1.51c-4 35.78 36.28 64 36.28 64l1-.38c-4.67-3.45-39.54-30.22-35.77-63.62z" fill="#fff" opacity={0.2} />
    <Path
    ...
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M191.47 423.33l.08-.27s-1.02-.2-.08.27z" transform="translate(-154.5 -94.48)" fill="url(#Data_svg__o)" opacity={0.2} />
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M40.08 336.46s-14.87 46.91 10.07 72.88l7.2-5.51s-14.74-51.2-6.49-63.22c-14.56-4.85-10.78-4.15-10.78-4.15z" fill="#ff5252" />
    ...
    <Path d="M56.34 406.85s-14.56-50.57-6.63-63c.7-.13 1.15-.23 1.15-.23l.13-.12.37.12c-8.25 12 6.49 63.22 6.49 63.22l-7.2 5.51-.63-.68z" fill="#fff" opacity={0.2} />
    ...
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M46.58 449.7s30.13 3.4 31.24 0c3.6-11-6-22.89-1.2-28.7 5-6 1.2-14.13 1.2-14.13a15.62 15.62 0 00-15.62-15.62 15.62 15.62 0 00-15.62 15.62z" fill="#ff5252" />
    <Path
    ...
    <Path
      ...
      fill="#f6b9ad"
    />
    <Path d="M70.94 409.39s46.81-15.17 53.44-50.56l-8.67-2.66s-34.45 38.46-49 38.73 4.23 14.49 4.23 14.49z" fill="#ff5252" />
    <Path d="M122.79 358.87l1.45.44c-6.63 35.39-53.44 50.56-53.44 50.56l-.83-.65c5.53-1.92 46.64-17.34 52.82-50.35z" fill="#fff" opacity={0.2} />
    <G opacity={0.2} fill="#fff">
    ...
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M46.58 448l-19 40a235 235 0 0133 4c21 4 31-6 31-6l-13.55-38z" fill="#263238" />
    ...
    <Path fill={props.primarycolor} d="M524.62 202.68h336v9h-336z" opacity={0.2} />
    ...
    <Path fill={props.primarycolor} opacity={0.5} d="M532.62 515.68h328v95h-328z" />
    ...
    />
    <Path d="M625.67 291.94l13.65-11.75a58.85 58.85 0 00-44.7-20.51v18a40.91 40.91 0 0131.05 14.26z" fill="#ff5252" />
    <Path d="M594.62 359.67A40.74 40.74 0 01577.7 356l-7.43 16.41a59 59 0 0054.49-3l-9.2-15.49a40.74 40.74 0 01-20.94 5.75z" fill="#69f0ae" />
    <Path d="M653.62 318.67a58.75 58.75 0 00-14.3-38.49l-13.65 11.75a40.93 40.93 0 01-10.11 62l9.2 15.49a59 59 0 0028.86-50.75z" fill="#ff9800" />
    <Path d="M553.62 318.67a41 41 0 0141-41v-18a59 59 0 00-24.35 112.74L577.7 356a41 41 0 01-24.08-37.33z" fill={props.primarycolor} />
    ...
    <Path stroke={props.primarycolor} strokeMiterlimit={10} strokeWidth={3} fill="url(#Data_svg__y)" d="M456.62 648.68h304" />
    ...
    />
    <Path d="M364.99 604.46s46.9 14.91 72.88-10l-5.51-7.21s-50.4 11.23-62.41 3-4.96 14.21-4.96 14.21z" fill={props.primarycolor} />
    <Path d="M436.55 593.52l.92 1.2c-26 24.92-72.88 10-72.88 10s-.12-.38-.3-1c5.59 1.67 48.02 13.08 72.26-10.2z" fill="#fff" opacity={0.2} />
    <Path d="M436.87 594.45s3.84.87 5.61-4.28-4.4-7.42-4.4-7.42-6.43 2.37-6.41 4.89 5.2 6.81 5.2 6.81z" fill="#985454" />
    <Path
      ...
      opacity={0.2}
    />
    <Path data-name="&lt;Path&gt;" d="M387.2 687.27h13.89a4.56 4.56 0 001.31 3.57c1.87 2.16 5.63 4.77 3.86 5.66H387.2z" fill={props.primarycolor} />
    <Path d="M401.39 690.84a4.56 4.56 0 01-1.31-3.57h1a4.56 4.56 0 001.31 3.57c1.87 2.16 5.63 4.77 3.86 5.66h-1c1.77-.89-1.99-3.49-3.86-5.66z" fill="#fff" opacity={0.2} />
    <Path data-name="&lt;Path&gt;" d="M337.73 684.41l13 2.13a6.62 6.62 0 00.59 4.58c1.42 3 4.61 6.74 2.69 7.55l-18.82-3z" fill={props.primarycolor} />
    <Path
      ...
      opacity={0.2}
    />
    <Rect x={514.15} y={650.64} width={14.11} height={20.91} rx={7.06} ry={7.06} transform="rotate(180 443.955 613.855)" fill="#985454" />
    ...
    <Path
      ...
      opacity={0.2}
    />
    <Path d="M350.58 625.7s30.13 3.4 31.24 0c7.81-23.94 0-42.83 0-42.83a15.62 15.62 0 00-15.62-15.62 15.62 15.62 0 00-15.62 15.62z" fill={props.primarycolor} />
    <Path d="M350.58 625.7l-13.61 62.49h13.61l14.11-46.36s17.64 7.56 22.17 22.68 0 23.68 0 23.68h14.64l.15-.68a65 65 0 00-19.8-61.81" fill="#263238" />
    <Path
    ...
    <Path d="M362.99 594.46s46.9 14.91 72.88-10l-5.51-7.21s-50.4 11.23-62.41 3-4.96 14.21-4.96 14.21z" fill={props.primarycolor} />
    <Path d="M434.55 583.52l.92 1.2c-26 24.92-72.88 10-72.88 10s-.12-.38-.3-1c5.59 1.67 48.02 13.08 72.26-10.2z" fill="#fff" opacity={0.2} />
    <Path d="M434.87 584.45s3.84.87 5.61-4.28-4.4-7.42-4.4-7.42-6.43 2.37-6.41 4.89 5.2 6.81 5.2 6.81z" fill="#985454" />
    <Path
    ...
    <Path d="M362.68 530.01c5.61.46 11.38 3.52 15.94 9.67.33.44-14 3-14 3l-1 21h3l1-21s14.33-2.56 14-3c-5.37-7.26-12.43-10.16-18.94-9.67z" fill="#fff" opacity={0.2} />
  </Svg>
);
