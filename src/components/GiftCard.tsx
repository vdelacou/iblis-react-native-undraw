...
export const SvgGiftCard = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 826.305 603.5" style={props.style} width="100%" height={props.height} {...props}>
    <Rect x={343.057} y={42.5} width={180} height={24} rx={5.421} fill={props.primarycolor} />
    <Rect x={321.057} y={0.5} width={462} height={531} rx={5.421} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={348.057} y={35.5} width={180} height={24} rx={5.421} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    ...
    <Rect x={371.557} y={118.5} width={361} height={12} rx={5.421} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={372.057} y={156.5} width={361} height={12} rx={5.421} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={372.557} y={194.5} width={361} height={12} rx={5.421} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Path
      ...
      fill="#f2f2f2"
    />
    <Path d="M504.057 329.5h102v79.055a9.445 9.445 0 01-9.445 9.445h-83.11a9.445 9.445 0 01-9.445-9.445V329.5h0z" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={489.557} y={303.5} width={132} height={26} rx={7.693} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    ...
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M154.186 69.592s20.21 37.995 16.976 58.205-6.467 37.995 0 47.696-34.761-1.617-34.761-1.617v-56.589z" fill="#ff6584" />
    <Path
    ...
    />
    <Path d="M145.697 547.762l-8.892 15.36 8.892 9.7h25.061s-8.084-16.167-4.85-23.443-20.21-1.617-20.21-1.617z" fill="#fbbebe" />
    <Path
    ...
    <Path
      ...
      fill={props.accentcolor}
    />
    <Path d="M144.59 129.05a29.975 29.975 0 01-23.92 1.31 85.236 85.236 0 00-2.458-13.477s24.252-7.275 25.06 7.276a11.086 11.086 0 001.318 4.89z" opacity={0.1} />
    ...
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M781.31 103.473a20.788 20.788 0 0114.98-13.198l1.714 10.184 3.177-10.696a20.81 20.81 0 11-19.87 13.71z" fill="#57b894" />
    <Path d="M782.453 99.795a20.788 20.788 0 0114.98-13.197l1.714 10.184 3.177-10.696a20.81 20.81 0 11-19.87 13.71z" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Path d="M796.904 213.489a20.81 20.81 0 0018.419-37.023l-2.441 8.22-1.731-10.304a.362.362 0 00-.053-.02 20.811 20.811 0 10-14.194 39.127z" fill="#57b894" />
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M775.237 248.051a20.801 20.801 0 104.01-16.297l9.273 13.957-12.67-7.408a20.617 20.617 0 00-.613 9.748z" fill="#57b894" />
    <Path d="M776.094 245.294a20.801 20.801 0 104.01-16.298l9.273 13.957-12.67-7.408a20.616 20.616 0 00-.613 9.749z" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
  </Svg>
);
