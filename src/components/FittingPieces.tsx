...
export const SvgFittingPieces = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 836.27 674.205" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path d="M655 59a17.99 17.99 0 01-6.333-34.832 17.99 17.99 0 108.666 34.664A18.07 18.07 0 01655 59z" fill={props.haircolor} />
    <Ellipse cx={661.5} cy={118.5} rx={4.5} ry={6.5} fill="#ffb8b8" />
    <Path d="M575 469c-24.755-3.685-54.742-2.828-87 0q20.173-36.99 0-65a360.885 360.885 0 0087 0c-12.389 20.626-11.296 42.384 0 65z" fill={props.primarycolor} />
