...
export const SvgInteractionDesign = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1121.04 851.8" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="InteractionDesign_svg__a" x1={590.32} y1={444.05} x2={590.32} y2={24.1} gradientTransform="matrix(-1 0 0 1 852.2 0)" gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="InteractionDesign_svg__b" x1={493.3} y1={875.74} x2={493.3} y2={319.35} xlinkHref="#InteractionDesign_svg__a" />
    </Defs>
    <G opacity={0.9}>
      <Path
      ...
      <Path
        ...
        fill="#fbbebe"
      />
      <Path d="M1006.29 265.56c-.3.36-.62.7-.93 1a33.75 33.75 0 01-46 2.92c.38-7.45.32-13.25.32-13.25s50.38-18 45.87-5.63c-1.6 4.54-.87 9.93.74 14.96z" opacity={0.1} />
      <Path d="M1014.59 242.29a33.76 33.76 0 11-33.77-33.78 33.56 33.56 0 0133.77 33.78z" fill="#fbbebe" />
      <Path d="M972.93 314.02s-13.22-29.32-17.73-29.32-11.54 151.65-11.54 151.65l69 1.09 2.82-79.63-14.08-70.58s-12.7 27.87-28.47 26.79z" opacity={0.1} />
      <Path d="M972.93 316.27s-13.22-29.32-17.73-29.32-11.54 151.66-11.54 151.66l78.25 1.18-6.47-79.73-14.08-70.57s-12.66 27.87-28.43 26.78z" opacity={0.1} />
      <Path d="M972.93 315.14s-13.22-29.31-17.73-29.31-11.54 151.65-11.54 151.65l78.25 1.18-6.47-79.76-14.08-70.58s-12.66 27.91-28.43 26.82z" fill="#65617d" />
      <Path
      ...
      <Path
        ...
        opacity={0.1}
      />
      <Path d="M905.57 505.9q-4.32-2.19-8.42-4.71-5.73-3.51-11.1-7.56l-3.45-28-.11-.92-6.55-53.28-.39-3.15 10.88-.33 7.7-.23.52 4.53 4.38 37.55.11.9z" fill="#b2b1bb" />
      <Path d="M897.15 501.17q-5.73-3.51-11.1-7.56l-3.45-28-.11-.92-6.55-53.28-.39-3.15 10.88-.33-.47 1.74.27 2.19 5.45 44.51.11.92z" opacity={0.1} />
      <Path
      ...
      <Path
        ...
        opacity={0.1}
      />
      <Path d="M1068.07 407.98l-.06 3.83-1.2 78.86c-.61.49-1.23 1-1.85 1.45v.58l-1.09.49v-.23l.18-31 .3-50.11v-4.36z" fill="#b2b1bb" />
      <Path
      ...
      <Path
        ...
        opacity={0.1}
      />
      <Path d="M869.68 282.9v110.92c0 1.91 1 2.18 2.69 3.1 5.63 3.12 19.49 8.68 36.13-.12 1.71-.9 2.76-1.2 2.76-3.14V283.59s-21.15 8.53-41.58-.69z" fill="#333f4f" />
    ...
    <G opacity={0.9}>
      ...
      <Path
        ...
        fill="#a1616a"
      />
      <Path d="M282.28 159.02a10 10 0 01-3.7 1.4c-4.83.15-8.81-12.93-8.81-12.93s1.38-1.39 3.57-3.34c1.54 3.56 5.9 13.1 8.94 14.87z" opacity={0.1} />
      <Path d="M251.3 154.31s4 .29 6.54-1.42 13.5-6.39 13.78-9.52c0 0 6.54 15.92 10.23 16.49 0 0-11.37 8.95-12.22 11.79s-23 9.8-23 9.8z" fill="#ff748e" />
      <Path d="M251.3 154.31s4 .29 6.54-1.42 13.5-6.39 13.78-9.52c0 0 6.54 15.92 10.23 16.49 0 0-11.37 8.95-12.22 11.79s-23 9.8-23 9.8z" fill="#5e5a6b" />
      <Path d="M128.98 413.65c.49.75 1.16 1.71 2 2.8.84.2 1.68.39 2.53.56a132.78 132.78 0 0017.77 2.57c-2.53-4.47-19-9.78-19-9.78l-2.23 2.6z" opacity={0.1} />
      <Path
      ...
      <Path
        ...
        opacity={0.1}
      />
      <Path d="M148.99 403.97a60.35 60.35 0 0012.65 0c7.53-.71 1.88 3.84-12.65 0zM145.58 408.81s9.95 5.68 13.79 2.84-3.7 2.74-13.79-2.84z" opacity={0.1} />
      <Path
      ...
      <Path
        ...
        opacity={0.1}
      />
      <Path d="M249.64 201.59l-.28 5.24c-1.8-1.31-4.3-2.77-6-2.22-2.84.95-22.92 2.66-22.92 2.66l.92-6.52z" opacity={0.1} />
      <Path
      ...
      <Path
        ...
        fill="#5e5a6b"
      />
      <Path d="M182.24 184.72c.57-.57 11.37-12.5 14.78-8.24s-14.78 8.24-14.78 8.24zM183.24 193.96c.42-.43 10.8-.85 13.36-6.68s-13.36 6.68-13.36 6.68z" opacity={0.1} />
      <G opacity={0.1}>
      ...
      <Path d="M286.42 150.9l.59.41a2.34 2.34 0 01-.6-3.26l26.33-38.23a2.35 2.35 0 013.26-.6l-.58-.4a3.76 3.76 0 011 5.23l-24.76 35.85a3.77 3.77 0 01-5.24 1z" fill="#464353" />
      <Path d="M315.516 108.87l.593.41-28.993 42.09-.593-.408a1.74 1.74 0 01-.446-2.42l27.02-39.225a1.74 1.74 0 012.42-.446z" fill="#9f9eff" />
      <Rect x={350.43} y={138.44} width={0.47} height={4.17} rx={0.17} ry={0.17} transform="rotate(34.56 369.694 65.033)" fill="#464353" />
    </G>
    <Path
    ...
    <Path
      ...
      fill="#514e7f"
    />
    <Path d="M535.42 830.46a6.24 6.24 0 01-6.24 6.24H346.96c-3.45 0 0-6.89 0-6.89s10.06-4.88 25-4l133-2.88s15.71.36 24.9 1.36a6.23 6.23 0 015.56 6.17z" opacity={0.1} />
    <Path fill={props.primarycolor} d="M483.7 783.55H369.36l3.16 34.77 132.44-2.3-21.26-32.47z" />
    <Path d="M289.79 807.97v12.07L170 824.9s-27.39-1.87-30.75-18.7a15.7 15.7 0 01.1-5.3c1.21-7.09 7.29-19.47 34.09-25.19l33-3.39h73.58s9.5 9.51 9.77 35.65z" fill="#514e7f" />
    <Path d="M289.79 808.35v11.69L170 824.9s-27.39-1.87-30.75-18.7a15.7 15.7 0 01.1-5.3s16.56 15.66 39 13.36l105.44-4.59a59.28 59.28 0 006-1.32z" opacity={0.1} />
    <Ellipse cx={237.35} cy={813.97} rx={36.83} ry={6.32} transform="rotate(-2.95 -250.07 1569.405)" opacity={0.1} />
    <Path d="M209.52 786.9l-19.38 9.58-20.62-4.88-.1-33.61c1.31-24.53-10-73.63-15.59-95.88q-3.23-12.9-5.65-26l-6.34-34.15-10.32-88.74h24.56l14.44 20.68z" fill="#514e7f" />
    <Path d="M209.52 786.9l-19.38 9.58-12.36-71.78c.24-12.23-15.09-70.29-16.09-72.68C149.47 622.85 139 513.26 139 513.26h17.09l14.43 20.64z" fill="#514e7f" />
    <Path d="M209.52 786.9l-19.38 9.58-12.36-71.78c.24-12.23-15.09-70.29-16.09-72.68C149.47 622.85 139 513.26 139 513.26h17.09l14.43 20.64z" opacity={0.15} />
    <Path
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M324.82 720.56l-65.77 69.34-7.74.55-98.7-316a30.15 30.15 0 01-2.77-11.55l97.76 13.12a12.08 12.08 0 019.9 8.3l70.77 221.15a15.2 15.2 0 01-3.45 15.09z" fill="#514e7f" />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M320 708.9l-70.92-220.89a14.87 14.87 0 0112.79 10.53l59.59 198.43A14.93 14.93 0 01320 708.9z" opacity={0.1} />
    <Circle cx={700.27} cy={344.15} r={37.55} fill="#945b79" />
    <Path d="M662.33 338.58a37.55 37.55 0 0135.31-37.49c-.74 0-1.48-.07-2.23-.07a37.56 37.56 0 100 75.11c.75 0 1.49 0 2.23-.07a37.55 37.55 0 01-35.31-37.48z" fill="#945b79" />
    <Path d="M667.19 344.15a37.55 37.55 0 0135.33-37.48c-.74 0-1.49-.07-2.24-.07a37.56 37.56 0 000 75.11c.75 0 1.5 0 2.24-.08a37.54 37.54 0 01-35.33-37.48z" opacity={0.1} />
    <Path
      ...
      fill="#ffc1c7"
    />
    <Path d="M507 765.18a101.83 101.83 0 01-10.82 4.93c-1.17-34.15-14.27-44.29-23.35-47.21 3-1.4 4.87-2.32 4.87-2.32h17.24z" opacity={0.1} />
    <Path
    ...
    <Path d="M613.44 599.28s1.51 24.13 16.81 22.19 3.66 51.28 3.66 51.28l-17 15.51-18.34 5.64s-16.16-4.74-15.94-5.61 6.46-51.27 6.46-51.27l9.48-26.94z" opacity={0.1} />
    <Path d="M613.44 601s1.51 24.13 16.81 22.2 3.66 51.28 3.66 51.28l-17 15.51-18.32 5.6s-16.16-4.74-15.94-5.6 6.46-51.28 6.46-51.28l9.48-26.93z" fill="#514e7f" />
    <Path
    ...
    <Path d="M703.72 517.34c-7.52 2.56-15.77 8.56-18.2 10.44-.45 0-2-1-5.1-9.73-.01 0 18.6-7.47 23.3-.71z" opacity={0.1} />
    <Path
