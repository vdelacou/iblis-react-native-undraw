...
export const SvgDelivery = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 896.26 886.06" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Delivery_svg__a" x1={654.31} y1={787.12} x2={654.31} y2={483.17} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="Delivery_svg__c" x1={310.24} y1={813.28} x2={310.24} y2={53.35} xlinkHref="#Delivery_svg__a" />
      ...
      <LinearGradient id="Delivery_svg__e" x1={309.36} y1={376.83} x2={309.36} y2={335.13} xlinkHref="#Delivery_svg__b" />
    ...
    <Path d="M482.07 377.47c0 38.09-69 146-69 146s-69-107.86-69-146a69 69 0 11137.93 0z" transform="translate(-103.74 -16.68)" fill="url(#Delivery_svg__b)" />
    <Circle cx={309.36} cy={355.98} r={20.85} fill="url(#Delivery_svg__e)" />
    <Path d="M363.11 369.32c0 29.68-53.75 113.74-53.75 113.74s-53.75-84.09-53.75-113.74a53.75 53.75 0 11107.49 0z" fill="#ff5252" />
