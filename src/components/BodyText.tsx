...
export const SvgBodyText = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1031 649.973" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path fill={props.accentcolor} d="M100.031 258.216h143.938v2H100.031zM100.031 279.216h143.938v2H100.031zM100.031 300.216h143.938v2H100.031z" />
    <Path
    ...
    <Path
      ...
      fill="#fbbebe"
    />
    <Path d="M449.445 246.832l-16.68-21.959s-32.32 5.96-35.32 8.96 8 58 8 58 2 15 11 23l9 6 74-15 2.783-32.926a86.41 86.41 0 00-22.783-66.074l-12.875 1.76z" fill="#575a89" />
    <Path d="M401.445 235.832l-5-2-23-2s-8-2-6-6 4-5 0-6-5-2-4-5 7-9 7-9l-17-14s-.92.651-2.407 1.855c-8.44 6.834-35.147 31.49-15.593 56.145 23 29 50 46 72 40z" fill="#575a89" />
    <Path
    ...
    <Path d="M261.367 485.073c-5.685 21.015-25.158 34.03-25.158 34.03s-10.255-21.057-4.57-42.072S256.797 443 256.797 443s10.255 21.057 4.57 42.073z" fill={props.primarycolor} />
    <Path d="M209.649 485.073c5.685 21.015 25.157 34.03 25.157 34.03s10.256-21.057 4.57-42.072S214.22 443 214.22 443s-10.255 21.057-4.57 42.073z" fill={props.primarycolor} />
    <Path
      ...
      fill={props.accentcolor}
    />
    <Path d="M690.367 42.073c-5.685 21.015-25.158 34.03-25.158 34.03s-10.255-21.057-4.57-42.072S685.797 0 685.797 0s10.255 21.057 4.57 42.073z" fill={props.primarycolor} />
    <Path d="M638.649 42.073c5.685 21.015 25.157 34.03 25.157 34.03s10.256-21.057 4.57-42.072S643.22 0 643.22 0s-10.255 21.057-4.57 42.073z" fill={props.primarycolor} />
    <Path
