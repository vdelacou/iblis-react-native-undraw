...
export const SvgCreation = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1038 764.064" style={props.style} width="100%" height={props.height} {...props}>
    <Path fill="#f2f2f2" d="M637 184.064h375v413H637z" />
    <Circle cx={262} cy={429.064} r={262} fill="#f2f2f2" />
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M996.917 571.224V455.131" />
    ...
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M850.007 571.379V189.375" />
    <Circle cx={850.007} cy={189.192} r={16.417} fill={props.accentcolor} />
    <Circle cx={799.583} cy={469.357} r={16.417} fill={props.accentcolor} />
    <Path d="M850.007 273.052s-2.345-50.443-50.424-44.58M850.007 416.052s-2.345-50.443-50.424-44.58" fill={props.accentcolor} />
    <Path d="M850.007 566.866s10.554-92.818-50.424-97.509" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={900.439} cy={469.357} r={16.417} fill={props.accentcolor} />
    <Path d="M850.014 566.866s-10.554-92.818 50.425-97.509" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={901.439} cy={315.357} r={16.417} fill={props.accentcolor} />
    <Path d="M851.014 412.866s-10.554-92.818 50.425-97.509" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M736.356 571.879V339.692" />
    ...
    <Path d="M736.356 567.366s10.554-92.818-50.424-97.509" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={685.932} cy={469.857} r={16.417} fill={props.accentcolor} />
    <Circle cx={736} cy={237.064} r={64} fill="#ff6584" />
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M45 33.064h992M282 763.064h519" />
    ...
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M662 159.064h375v413H662zM136 173.064v512" />
    <Circle cx={550} cy={730.064} r={33} fill={props.primarycolor} />
    <Path fill="#fff" d="M562.412 717.913l-16.534 16.534-7.833-7.834-3.05 3.05 10.873 10.873 19.594-19.573-3.05-3.05z" />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Path d="M222.46 561.042h8.022l40.107 52.584s-7.13 16.934-17.826 18.716c0 0-1.782-.89-9.803-6.238s-29.412-32.086-29.412-32.086l-2.674-15.15z" fill={props.haircolor} />
