...
export const SvgZoomIn = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1104 560.271" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path d="M59.409 523.87c6.073 22.45 26.875 36.354 26.875 36.354s10.955-22.495 4.882-44.945-26.875-36.354-26.875-36.354-10.956 22.495-4.882 44.945z" fill="#fff" />
    <Path d="M68.333 519.045c16.665 16.223 18.7 41.16 18.7 41.16s-24.984-1.363-41.648-17.586-18.7-41.16-18.7-41.16 24.983 1.364 41.648 17.586z" fill={props.accentcolor} />
    <Path opacity={0.1} d="M442.23 0L0 303.64v-69.18L341.53 0h100.7zM274.97 0L0 188.77v-69.14L174.26 0h100.71zM93.46 0L0 64.16V0h93.46z" />
    ...
    <Path d="M607.694 228.177c-12.677 46.86-56.097 75.883-56.097 75.883s-22.867-46.954-10.19-93.815 56.096-75.882 56.096-75.882 22.868 46.954 10.191 93.815z" fill="#fff" />
    <Path d="M492.372 228.177c12.677 46.86 56.097 75.883 56.097 75.883s22.867-46.954 10.19-93.815-56.096-75.882-56.096-75.882-22.867 46.954-10.19 93.814z" fill="#fff" />
    <Path
    ...
    />
    <Path d="M640.172 560.271a12 12 0 1112-12 12.014 12.014 0 01-12 12zm0-22a10 10 0 1010 10 10.011 10.011 0 00-10-10z" fill="#f0f0f0" />
    <Path d="M263 317.561h-19.741v-19.74H263zm-18.223-1.518h16.704v-16.704h-16.704z" fill={props.accentcolor} />
    <Path d="M792.644 455.641l-13.465-14.436 14.436-13.465 13.465 14.436zm-11.319-14.361l11.394 12.215 12.215-11.393-11.394-12.216z" fill="#f0f0f0" />
    ...
    <Path d="M875.31 117.072a29.116 29.116 0 1129.116-29.116 29.149 29.149 0 01-29.116 29.116z" fill={props.accentcolor} />
