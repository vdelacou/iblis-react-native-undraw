...
export const SvgFeelingHappy = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 644 673" style={props.style} width="100%" height={props.height} {...props}>
    ...
    />
    <Circle cx={519} cy={125} r={125} fill={props.primarycolor} />
    <Circle cx={472} cy={100} r={32} fill="#fff" />
    <Path d="M482.026 164A19.024 19.024 0 00501 182h52a19.024 19.024 0 0018.974-18z" fill="#fff" />
    <Circle cx={460} cy={110.5} r={17} fill={props.accentcolor} />
    <Circle cx={466} cy={103.5} r={4} fill="#fff" />
    <Circle cx={576} cy={100.5} r={32} fill="#fff" />
    <Circle cx={564} cy={110.5} r={17} fill={props.accentcolor} />
    <Circle cx={570} cy={103.5} r={4} fill="#fff" />
    <Circle cx={521} cy={136} r={12} fill={props.accentcolor} />
    <Path fill={props.primarycolor} d="M517 243h22v17h-22z" />
    <Path d="M223.262 577.12s14.116 41.34 8.066 56.465l18.15 16.133 11.091-14.117s-12.1-12.1-11.091-21.174 2.016-41.341 2.016-41.341z" fill={props.skincolor} />
    <Path
    ...
    />
    <Path d="M182.93 561.994l-26.217 31.258-7.058 16.133 9.075 7.058 8.066-3.025s7.058-18.15 14.117-21.174 24.2-23.191 24.2-23.191z" fill={props.skincolor} />
    <Path
    ...
    />
    <Circle cx={208.641} cy={276.138} r={21.175} fill={props.skincolor} />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Circle cx={159.234} cy={235.806} r={19.158} fill={props.haircolor} />
    <Path
