...
export const SvgResponsive = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 971.44 502" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Responsive_svg__a" x1={599.5} y1={668.05} x2={599.5} y2={199} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="Responsive_svg__b" x1={485.72} y1={258.88} x2={485.72} y2={71.12} xlinkHref="#Responsive_svg__a" />
      <LinearGradient id="Responsive_svg__c" x1={132} y1={515} x2={303} y2={515} xlinkHref="#Responsive_svg__a" />
      <LinearGradient id="Responsive_svg__d" x1={933} y1={568.28} x2={1031} y2={568.28} xlinkHref="#Responsive_svg__a" />
    </Defs>
    <Path
    ...
    <Path d="M235.82 3h499.8a16.1 16.1 0 0116.1 16.1V327h-532V19.1A16.1 16.1 0 01235.82 3z" fill="#535461" />
    <Path d="M735.62 377h-499.8a16.1 16.1 0 01-16.1-16.1V327h532v33.9a16.1 16.1 0 01-16.1 16.1z" fill="#bdbdbd" />
    <Circle cx={485.72} cy={352} r={9} fill="#535461" />
    <Path d="M399.89 436h171.66a8.17 8.17 0 018.17 8.17V456h-188v-11.83a8.17 8.17 0 018.17-8.17z" fill="#bdbdbd" />
    <Rect x={320.72} y={71.12} width={330} height={187.76} rx={4.5} ry={4.5} fill="url(#Responsive_svg__b)" opacity={0.5} />
    <Rect x={324.95} y={72.5} width={321.54} height={183.96} rx={4.5} ry={4.5} fill="#fff" />
    <Rect x={414.52} y={98.91} width={35.44} height={31.9} rx={4.5} ry={4.5} fill={props.primarycolor} opacity={0.5} />
    ...
    <Rect x={414.52} y={148.53} width={35.44} height={31.9} rx={4.5} ry={4.5} fill={props.primarycolor} opacity={0.5} />
    ...
    <Rect x={414.52} y={198.15} width={35.44} height={31.9} rx={4.5} ry={4.5} fill={props.primarycolor} opacity={0.5} />
    ...
    <Path stroke={props.primarycolor} strokeMiterlimit={10} strokeWidth={2} d="M485.72 42V20M485.72 79V50.13" />
    <Circle cx={485.72} cy={79} r={4} fill={props.primarycolor} />
    <Circle cx={485.72} cy={46} r={4} fill="none" stroke="#fff" strokeMiterlimit={10} />
    <Path stroke={props.primarycolor} strokeMiterlimit={10} strokeWidth={2} d="M485.72 42V20M485.72 79V50.13" />
    <Circle cx={485.72} cy={79} r={4} fill={props.primarycolor} />
    <Circle cx={485.72} cy={46} r={4} fill="none" stroke="#fff" strokeMiterlimit={10} />
    <Path stroke={props.primarycolor} strokeMiterlimit={10} strokeWidth={2} d="M485.72 279v31M485.72 251v28.87" />
    <Circle cx={485.72} cy={251} r={4} fill={props.primarycolor} />
    <Path stroke={props.primarycolor} strokeMiterlimit={10} strokeWidth={2} d="M305.72 168.5h-31.5M333.22 168.5h-28.87" />
    ...
    <Path
      ...
      opacity={0.7}
    />
    <Path d="M102.72 389s-19-83 23-190" fill="none" stroke="#535461" strokeMiterlimit={10} strokeWidth={3} opacity={0.6} />
    <Path d="M28.72 364h147s29 37-16 92h-116s-42-38-15-92z" fill={props.primarycolor} />
    <Path
    ...
    <Path stroke={props.primarycolor} strokeMiterlimit={10} strokeWidth={2} d="M690.22 168.5h6M637.22 168.5h44.88" />
    ...
    <Path d="M821.72 352h92v79.5a23.5 23.5 0 01-23.5 23.5h-45a23.5 23.5 0 01-23.5-23.5V352z" fill={props.primarycolor} />
    <Path d="M821.72 352v4h88v79.5a23.39 23.39 0 01-5 14.49 23.45 23.45 0 009-18.49V352z" opacity={0.1} />
  </Svg>
);
