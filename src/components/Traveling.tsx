...
export const SvgTraveling = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 865 779.064" style={props.style} width="100%" height={props.height} {...props}>
    <Rect x={406} y={27.5} width={459} height={594} rx={38.142} fill="#f2f2f2" />
    <Rect x={384} y={0.5} width={459} height={594} rx={38.142} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
