...
export const SvgCoolness = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 974.683 719.807" style={props.style} width="100%" height={props.height} {...props}>
    <Path d="M497.543 13.447L234.44 155.957a66.93 66.93 0 11-117.65 63.727l-89.71 48.592L259.457 697.29l470.463-254.83z" fill="#f2f2f2" />
    <Path fill={props.primarycolor} opacity={0.2} d="M182.3 376.321l48.305 12.905-12.904 48.306-48.306-12.904z" />
    <Path
    ...
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M163 717.926h273M0 717.926h129" />
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M65.477 719.128v-74.411" />
    <Circle cx={65.477} cy={644.717} r={10.523} fill={props.accentcolor} />
    <Path d="M65.477 690.578s-1.503-32.332-32.32-28.574" fill={props.accentcolor} />
    <Circle cx={276.75} cy={427.314} r={20.289} fill={props.accentcolor} />
    <Circle cx={213.117} cy={427.314} r={14.756} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={340.383} cy={427.314} r={14.756} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M271.474 717.807L283 466.926" />
    <Circle cx={914.25} cy={271.756} r={20.289} fill={props.accentcolor} />
    <Circle cx={494.617} cy={15.756} r={14.756} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={326.883} cy={107.756} r={14.756} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={654.988} cy={129.132} r={47.763} fill="#ff6584" />
    <Path fill="#fbbebe" d="M764.924 551.174l25.529 102.938 25.528-4.118-25.528-117.76-25.529 18.94z" />
    <Path
    ...
    />
    <Path fill="#fbbebe" d="M664.458 638.465L660.34 660.7h28.823v-22.235h-24.705z" />
    <Path
    ...
    <Path
      ...
      fill="#fbbebe"
    />
    <Path d="M657.87 232.48s-46.94 76.586-41.175 78.233 59.292 18.94 61.762 12.353 2.47-37.058 2.47-37.058z" fill={props.haircolor} />
    <Path d="M657.87 232.48s-46.94 76.586-41.175 78.233 59.292 18.94 61.762 12.353 2.47-37.058 2.47-37.058z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Path d="M691.633 176.483l9.882-6.588s41.175 24.705 69.998 26.352 27.998 18.117 16.47 29.646-56.822 51.057-58.469 41.175-37.88-90.585-37.88-90.585z" fill={props.haircolor} />
    <Ellipse cx={654.988} cy={115.956} rx={32.94} ry={19.764} fill="#ff6584" />
    ...
    <Path
      ...
      fill="#ff6584"
    />
    <Circle cx={172.564} cy={189.569} r={54.315} fill={props.primarycolor} />
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M495.5 718.368h392" />
    <Path
