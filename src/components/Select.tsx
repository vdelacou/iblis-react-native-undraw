...
export const SvgSelect = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 666.24 728.82" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Select_svg__a" x1={600} y1={814.41} x2={600} y2={85.59} gradientTransform="translate(-266.87 -85.6)" gradientUnits="userSpaceOnUse">
    ...
    <Path fill="#fff" d="M282.37 134.72h71.38v12.52h-71.38zM282.37 158.51h196.62v12.52H282.37zM282.37 182.31h196.62v12.52H282.37z" />
    <Circle cx={203.47} cy={283.75} r={40.07} fill="#fff" />
    <Path fill="#fff" d="M282.37 253.69h71.38v12.52h-71.38zM282.37 277.49h196.62v12.52H282.37zM282.37 301.28h196.62v12.52H282.37z" />
    <Circle cx={203.47} cy={402.72} r={40.07} fill="#fff" />
    <Path fill="#fff" d="M282.37 372.66h71.38v12.52h-71.38zM282.37 396.46h196.62v12.52H282.37zM282.37 420.25h196.62v12.52H282.37z" />
    <Circle cx={203.47} cy={521.69} r={40.07} fill="#fff" />
    <Path fill="#fff" d="M282.37 491.63h71.38v12.52h-71.38zM282.37 515.43h196.62v12.52H282.37zM282.37 539.22h196.62v12.52H282.37z" />
    <Circle cx={203.47} cy={640.66} r={40.07} fill="#fff" />
    <Path fill="#fff" d="M282.37 610.61h71.38v12.52h-71.38zM282.37 634.4h196.62v12.52H282.37zM282.37 658.19h196.62v12.52H282.37z" />
    ...
    <Path fill="#fff" d="M209.98 386.44l-11.1-8.47-29.24 38.32-16.32-12.46-8.47 11.1 21.88 16.7.06-.08 5.53 4.22 37.66-49.33z" />
  </Svg>
);
