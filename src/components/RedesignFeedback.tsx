...
export const SvgRedesignFeedback = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 886.295 670.668" style={props.style} width="100%" height={props.height} {...props}>
    <Path
    ...
    <Path fill="#e6e6e6" d="M369.291 229.899h14.755v14.755h-14.755zM369.291 253.672h14.755v14.755h-14.755zM369.291 277.444h14.755v14.755h-14.755z" />
    ...
    <Path d="M746.888 346.116l-9.078 33.717s-4.538 27.233 3.242 27.882 5.836-27.233 5.836-27.233l14.913-23.343z" fill="#fbbebe" />
    <Path
    ...
    <Path
      ...
      fill="#e6e6e6"
    />
    <Path d="M796.882 253.528s-14.656-6.942-21.14 3.433-24.64 65.488-24.64 65.488l-8.429 25.288 20.75 12.32 40.849-75.215s5.97-22.427-7.39-31.314z" fill="#e6e6e6" />
    <Path
    ...
    <Path fill="#e6e6e6" d="M585.594 631.888h24.458v24.458h-24.458zM682.788 426.8h-662v-395h662zm-660-2h658v-391h-658z" />
  </Svg>
);
