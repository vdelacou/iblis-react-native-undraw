...
export const SvgEducator = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 534.14 692" style={props.style} width="100%" height={props.height} {...props}>
    <Circle data-name="319da30a-b754-4c25-967a-210e088b184d" cx={267.07} cy={179.86} r={179.86} fill="#ffd9cb" />
    <Path d="M292.96 239.82c0 6.77-11.59 12.26-25.89 12.26s-25.89-5.49-25.89-12.26 11.59-12.27 25.89-12.27 25.89 5.45 25.89 12.27z" fill="#fff" />
    ...
    <Path
      ...
      fill="#69f0ae"
    />
    <Path d="M248.98 312.44c1.36-5.54 7.84-8 13.5-8.76 8.4-1.17 18.36 0 23 7.13" fill="#bf655b" opacity={0.2} />
    ...
    <Path d="M213.76 440.25l106.45-.13v-95.38a16.4 16.4 0 00-16.35-16.35h-73.58a16.4 16.4 0 00-16.35 16.35v95.38" fill="#ffd9cb" />
    <Path
