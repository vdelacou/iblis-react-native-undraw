...
export const SvgPredictiveAnalytics = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 798.681 647.009" style={props.style} width="100%" height={props.height} {...props}>
    <Path fill="#f2f2f2" d="M126.832 0L74.02 103.009h10.661v84H30.953L0 247.381l383.53 196.636 126.833-247.381L126.832 0z" />
    <Path fill={props.accentcolor} d="M115.681 67.009h588v295h-588z" />
    <Path
    ...
    />
    <Ellipse cx={566.681} cy={630.009} rx={186} ry={17} fill={props.accentcolor} />
    <Path
      fill={props.primarycolor}
    ...
    />
    <Path d="M396.757 595.847c4.7 17.373 20.798 28.134 20.798 28.134s8.478-17.409 3.778-34.783-20.798-28.134-20.798-28.134-8.478 17.409-3.778 34.783z" fill={props.accentcolor} />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Circle cx={765.181} cy={53.509} r={33.5} fill={props.primarycolor} opacity={0.4} />
    <Circle cx={703.181} cy={69.509} r={23.5} fill={props.primarycolor} opacity={0.4} />
    <Circle cx={674.181} cy={500.509} r={12.5} fill={props.primarycolor} opacity={0.4} />
    <Circle cx={461.181} cy={565.509} r={9.5} fill={props.primarycolor} opacity={0.4} />
    <Circle cx={429.181} cy={439.509} r={12.5} fill={props.primarycolor} opacity={0.4} />
    <Circle cx={608.181} cy={173.509} r={13} fill={props.primarycolor} />
    <Path
    ...
    <Path d="M533.51 230.197l3.673 23.266 26.94-4.898s-1.225-23.266-1.225-25.715-29.388 7.347-29.388 7.347z" fill="#ffb8b8" />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Path fill={props.accentcolor} d="M12.681 115.009h64v64h-64z" />
  </Svg>
);
