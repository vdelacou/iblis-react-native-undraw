...
export const SvgBroadcast = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 605.25 761.48" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Broadcast_svg__a" x1={304.32} y1={452.8} x2={304.32} y2={148.23} gradientUnits="userSpaceOnUse">
    ...
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M280.56 753.65V18.99a19 19 0 0119-19h11.26a19 19 0 0119 19v734.66c-.02 10.44-49.26 10.44-49.26 0z" fill="#535461" />
    ...
    <Path
      ...
      fill="#e0e0e0"
    />
    <Path fill="none" stroke={props.primarycolor} strokeLinecap="round" strokeMiterlimit={10} strokeWidth={2} d="M302.63 288.42v11.46M307.43 293.44a10.19 10.19 0 11-9.42-.09" />
  </Svg>
);
