...
export const SvgLocationReview = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 840.5 757.831" style={props.style} width="100%" height={props.height} {...props}>
    <Path fill={props.accentcolor} d="M534.25 438.618l-116-138-232.846 2.128L44.156 440.325l2.854 1.834h-1.019v286.165h487.946V442.159l.313-3.541z" />
    ...
    />
    <Path d="M821.92 447.831l3 52s14 33-5 32-7-33-7-33l-18.603-46.41zM667.92 432.831l-3 52s-14 33 5 32 7-33 7-33l18.602-46.41z" fill="#a0616a" />
    ...
    <Path
      ...
      fill="#e6e6e6"
    />
    <Path d="M803.92 363.831l13 17s13 71 9 72-28 9-32 6-22-62-22-62zM697.92 358.831l-17 11s-25 70-18 73 46 1 46 1z" fill="#e6e6e6" />
    <Path
    ...
    <Path fill={props.primarycolor} d="M590.1 124.408l-14.816-25.661-14.815-25.661H619.73l-14.815 25.661-14.815 25.661z" />
