...
export const SvgDoneChecking = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 967.858 731.613" style={props.style} width="100%" height={props.height} {...props}>
    ...
    />
    <Path fill={props.haircolor} d="M40.268 494.782l1.465-1.363 67 72-1.466 1.363zM128.198 619.521l33.984-47.012 1.621 1.172-33.984 47.012z" />
    ...
    <Path d="M512 667.101c21.213 22.742-1.823 102.25-256 43-137.694-32.096-256-31.402-256-43s114.615 1 256 1 248.089-9.48 256-1z" fill={props.accentcolor} />
    <Path d="M512 667.101c21.213 22.742-1.823 102.25-256 43-137.694-32.096-256-31.402-256-43s114.615 1 256 1 248.089-9.48 256-1z" opacity={0.1} />
    <Path d="M512 667.101c21.213 22.742-1.823 80.25-256 21-137.694-32.096-256-9.402-256-21s114.615-21 256-21 248.089 12.52 256 21z" fill={props.accentcolor} />
    <Path d="M245.771 159.101h11.503a27.612 27.612 0 0127.612 27.612v39.115H218.16v-39.115a27.612 27.612 0 0127.612-27.612z" fill={props.haircolor} />
    <Path
      ...
      fill="#a0616a"
    />
    <Path d="M239.32 212.93s2.798 22.381-3.497 23.78-9.093 9.792-9.093 9.792l20.983 13.289 21.682-4.197-2.098-16.086s-5.595-16.087-2.798-26.579-25.179 0-25.179 0z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Ellipse cx={342.608} cy={281.182} rx={1.696} ry={4.524} transform="rotate(-16.16 -11.955 647.884)" fill="#a0616a" />
    <Ellipse cx={391.314} cy={282.581} rx={4.524} ry={1.696} transform="rotate(-73.84 277.252 317.724)" fill="#a0616a" />
    ...
    <Path fill={props.accentcolor} d="M489.38 212.063h66v66h-66zM464.38 292.063h116v8h-116zM464.38 314.063h116v8h-116zM464.38 336.063h116v8h-116z" />
    ...
    <Path fill={props.accentcolor} d="M739.38 90.063h104v12h-104zM739.38 116.063h104v12h-104zM739.38 142.063h104v12h-104z" />
