...
export const SvgCountingStars = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 922.185 747.357" style={props.style} width="100%" height={props.height} {...props}>
    <Path
    ...
    />
    <Path fill="#fff" d="M553.004 198.924l-2.862-1.82 1.821-2.862-.78-.496-1.821 2.861-2.861-1.821-.497.781 2.862 1.82-1.821 2.862.78.497 1.821-2.862 2.861 1.821.497-.781z" />
    ...
    <Path d="M125.905 378.896s4.258 22.51 1.217 24.943 23.117 6.083 23.117 6.083 3.042-29.809 3.65-32.85-27.984 1.824-27.984 1.824z" fill="#9f616a" />
    <Path
    ...
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path opacity={0.1} d="M125.004 451.746l-6 65 20 45-13-46-1-65M154.004 458.746l1.528 76.629-5.528-41.629 4-35z" />
