...
export const SvgActiveSupport = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 900.1 696.67" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="ActiveSupport_svg__a" x1={583.82} y1={763.13} x2={583.82} y2={246.35} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="ActiveSupport_svg__b" x1={584.38} y1={798.34} x2={584.38} y2={714.29} xlinkHref="#ActiveSupport_svg__a" />
      <LinearGradient id="ActiveSupport_svg__c" x1={760.68} y1={248.69} x2={760.68} y2={0} xlinkHref="#ActiveSupport_svg__a" />
    </Defs>
    <Path
      d="M971.12 763.13h-774.6v-501a15.8 15.8 0 0115.8-15.8h743a15.8 15.8 0 0115.8 15.8z"
      transform="translate(-149.95 -101.66)"
      fill="url(#ActiveSupport_svg__a)"
      opacity={0.8}
    />
    ...
    <Path
      ...
      transform="translate(-149.95 -101.66)"
      fill="url(#ActiveSupport_svg__b)"
      opacity={0.8}
    />
    <Path
      d="M862.62 620.01h-369a11.33 11.33 0 01-8.6 18.74H344.14a11.33 11.33 0 01-8.6-18.74H5.11s-.57 55.09 32.94 69.33c25.55 1.7 757 2.84 799.59 0 32.41-18.79 24.98-69.33 24.98-69.33z"
      fill="#f5f5f5"
    />
    ...
    <Path d="M419.88 375.85h32.19a139.5 139.5 0 01139.5 139.5v101.41H280.38V515.35a139.5 139.5 0 01139.5-139.5z" fill={props.primarycolor} />
    <Circle cx={436.28} cy={179.39} r={142.22} fill="#333" />
    <Path d="M415.34 334.43h41.13a29 29 0 0129 29v28.26a44.34 44.34 0 01-44.34 44.34h-10.49a44.34 44.34 0 01-44.34-44.34v-28.22a29 29 0 0129-29z" opacity={0.1} />
    <Path d="M386.3 331.53h99.22v57.3a44.34 44.34 0 01-44.34 44.34h-10.54a44.34 44.34 0 01-44.34-44.34v-57.3z" fill="#fdb797" />
    <Path d="M386.48 345.84a142.8 142.8 0 0099.22.27v-12.18h-99.22z" opacity={0.1} />
    ...
    <Path
      ...
      fill="#333"
    />
    <Path fill="none" stroke="#000" strokeMiterlimit={10} strokeWidth={4} opacity={0.05} d="M341.3 506.34v110.42M533.14 506.34v110.42" />
    <Path fill="url(#ActiveSupport_svg__c)" d="M900.1 198.47H721.64l-60.23 50.22v-50.22h-40.15V0H900.1v198.47z" opacity={0.8} />
    ...
    <Path fill={props.primarycolor} d="M655.59 106.45H798v5.64H655.59zM655.59 131.84h214.95v5.64H655.59z" />
