...
export const SvgTakingSelfie = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 836.965 677.027" style={props.style} width="100%" height={props.height} {...props}>
    ...
    />
    <Ellipse cx={495.517} cy={344.013} rx={34} ry={20.5} transform="rotate(-48.312 280.468 490.634)" fill={props.haircolor} />
    ...
    <Ellipse cx={641.517} cy={360.013} rx={20.5} ry={34} transform="rotate(-25.902 308.363 698.928)" fill={props.haircolor} />
  </Svg>
);
