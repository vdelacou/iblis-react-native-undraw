...
export const SvgNotFound = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1120.592 777.916" style={props.style} width="100%" height={props.height} {...props}>
    <Circle cx={212.592} cy={103} r={64} fill="#ff6584" />
    <Path d="M523.976 343.122c0 151.011-89.774 203.739-200.515 203.739s-200.516-52.728-200.516-203.74S323.461 0 323.461 0s200.515 192.11 200.515 343.122z" fill="#f2f2f2" />
    <Path
    ...
    />
    <Path d="M1120.592 404.972c0 123.61-73.484 166.77-164.131 166.77s-164.132-43.16-164.132-166.77S956.461 124.11 956.461 124.11s164.131 157.252 164.131 280.862z" fill="#f2f2f2" />
    <Path
      fill={props.accentcolor}
    ...
    />
    <Ellipse cx={554.592} cy={680.479} rx={554.592} ry={28.034} fill={props.accentcolor} />
    <Ellipse cx={892.445} cy={726.797} rx={94.989} ry={4.802} fill={props.accentcolor} />
    <Ellipse cx={548.72} cy={773.114} rx={94.989} ry={4.802} fill={props.accentcolor} />
    <Ellipse cx={287.944} cy={734.279} rx={217.014} ry={10.97} fill={props.accentcolor} />
    <Circle cx={97.084} cy={566.27} r={79} fill={props.haircolor} />
    <Path fill={props.haircolor} d="M60.355 627.841l23.999.283-.507 42.997-23.998-.283zM108.352 628.407l23.999.283-.507 42.997-23.998-.283z" />
    <Ellipse cx={119.546} cy={732.616} rx={7.5} ry={20} transform="rotate(-89.325 68.811 722.182)" fill={props.haircolor} />
    <Ellipse cx={167.554} cy={732.182} rx={7.5} ry={20} transform="rotate(-89.325 116.82 721.748)" fill={props.haircolor} />
    <Circle cx={99.319} cy={546.295} r={27} fill="#fff" />
    <Circle cx={99.319} cy={546.295} r={9} fill={props.accentcolor} />
    <Path d="M21.322 491.904c-6.042-28.64 14.688-57.265 46.3-63.933s62.139 11.143 68.18 39.783-14.978 38.93-46.59 45.6-61.848 7.191-67.89-21.45z" fill={props.primarycolor} />
    <Path
    ...
    <Path
      ...
      fill={props.accentcolor}
    />
    <Circle cx={712.485} cy={565.415} r={79} fill={props.haircolor} />
    <Path fill={props.haircolor} d="M696.287 635.256l22.94-7.05 12.633 41.102-22.941 7.05zM742.168 621.16l22.94-7.05 12.632 41.102-22.94 7.05z" />
    <Ellipse cx={767.887} cy={732.003} rx={20} ry={7.5} transform="rotate(-17.083 544.826 833.656)" fill={props.haircolor} />
    <Ellipse cx={813.475} cy={716.946} rx={20} ry={7.5} transform="rotate(-17.083 590.415 818.599)" fill={props.haircolor} />
    <Circle cx={708.522} cy={545.71} r={27} fill="#fff" />
    <Circle cx={708.522} cy={545.71} r={9} fill={props.accentcolor} />
    <Path
    ...
    <Path
      ...
      fill={props.accentcolor}
    />
    <Ellipse cx={721.517} cy={656.822} rx={12.4} ry={39.5} transform="rotate(-64.626 653.41 657.688)" fill={props.haircolor} />
    <Ellipse cx={112.517} cy={651.822} rx={12.4} ry={39.5} transform="rotate(-68.158 47.55 650.645)" fill={props.haircolor} />
  </Svg>
);
