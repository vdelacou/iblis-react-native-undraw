...
export const SvgInvesting = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 893.617 736.75" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M821.418 409.219a15.51 15.51 0 0111.177-9.847l1.279 7.598 2.37-7.98a15.527 15.527 0 11-14.826 10.229z" fill="#57b894" />
    <Path d="M822.271 406.475a15.51 15.51 0 0111.177-9.847l1.279 7.598 2.37-7.98a15.527 15.527 0 11-14.826 10.23z" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Path d="M833.053 491.305a15.527 15.527 0 0013.743-27.624l-1.821 6.133-1.292-7.688a.271.271 0 00-.04-.015 15.528 15.528 0 10-10.59 29.194z" fill="#57b894" />
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M816.887 517.093a15.52 15.52 0 102.992-12.16l6.919 10.414-9.454-5.527a15.383 15.383 0 00-.457 7.273z" fill="#57b894" />
    <Path d="M817.526 515.035a15.52 15.52 0 102.993-12.16l6.918 10.414-9.453-5.527a15.383 15.383 0 00-.458 7.273z" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Path d="M801.757 557.359s13.703-5.37 17.832-8.311 21.079-6.452 22.103-1.736 20.593 23.457 5.123 23.582-35.947 2.538-40.069.027-4.99-13.562-4.99-13.562z" fill="#656380" />
    <Path
    ...
    <Rect x={167} y={405} width={60} height={158} rx={11.851} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={281} y={310} width={60} height={253} rx={11.851} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={395} y={244} width={60} height={319} rx={11.851} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={509} y={181} width={60} height={382} rx={11.851} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    <Rect x={623} y={71} width={60} height={492} rx={11.851} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M683.735 308.69l-4.392 3.765s-5.647 33.251-5.02 41.407-13.174 131.752-2.509 131.752 22.586-1.882 20.704-6.274 3.133-78.762 3.133-78.762l5.65-65.537z" fill="#575a89" />
    <Path
