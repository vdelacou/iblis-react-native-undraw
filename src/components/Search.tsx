...
export const SvgSearch = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 871.909 596.6" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      ...
      <LinearGradient id="Search_svg__c" x1={895.456} y1={298.735} x2={895.456} y2={178.444} gradientUnits="userSpaceOnUse">
      ...
      <LinearGradient id="Search_svg__a" x1={858.283} y1={221.343} x2={858.283} y2={215.554} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopOpacity={0.12} />
        <Stop offset={0.551} stopOpacity={0.09} />
        <Stop offset={1} stopOpacity={0.02} />
      </LinearGradient>
      <LinearGradient id="Search_svg__d" x1={884.876} y1={214.701} x2={884.876} y2={196.998} xlinkHref="#Search_svg__a" />
    </Defs>
    ...
    />
    <Path d="M858.283 215.554c-3.726 0-3.732 5.79 0 5.79 3.725 0 3.731-5.79 0-5.79z" transform="translate(-164.046 -151.7)" fill="url(#Search_svg__a)" />
    <Path
    ...
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path fill="#e0e0e0" d="M4.909 240.6h867v59h-867zM4.909 339.6h867v59h-867zM4.909 438.6h867v59h-867zM4.909 537.6h867v59h-867z" />
  </Svg>
);
