...
export const SvgNextJs = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 888 442.25" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Circle cx={857.378} cy={271.935} r={28.894} fill={props.primarycolor} />
    <Circle cx={869.392} cy={309.404} r={3.677} />
    <Path d="M327.528 169.829h115.22v9.158H338.09v68.924h98.416v9.158H338.09v75.672h105.857v9.157H327.528zm125.541 0h12.242l54.249 75.672 55.449-75.672 75.42-96.12L526.52 253.453l63.85 88.444H577.65l-58.09-80.491-58.329 80.491h-12.482l64.33-88.444zm141.863 9.158v-9.158h131.302v9.158h-60.49v162.911h-10.562V178.987zm-411.547-9.158h13.202l182.05 272.42-75.232-100.35-108.978-159.056-.48 159.055h-10.562zM725.17 329.977a3.833 3.833 0 113.776-3.833 3.733 3.733 0 01-3.776 3.833zm10.378-10.083h5.651c.077 3.06 2.312 5.119 5.6 5.119 3.674 0 5.754-2.212 5.754-6.354v-26.236h5.755v26.262c0 7.46-4.316 11.755-11.457 11.755-6.705 0-11.303-4.167-11.303-10.546zm30.286-.334h5.703c.488 3.524 3.93 5.761 8.889 5.761 4.624 0 8.014-2.392 8.014-5.684 0-2.83-2.157-4.527-7.064-5.685l-4.778-1.157c-6.705-1.57-9.762-4.81-9.762-10.263 0-6.61 5.395-11.01 13.487-11.01 7.527 0 13.024 4.4 13.358 10.65h-5.6c-.54-3.421-3.52-5.556-7.835-5.556-4.547 0-7.578 2.186-7.578 5.53 0 2.65 1.952 4.167 6.781 5.299l4.085 1.003c7.604 1.774 10.738 4.861 10.738 10.443 0 7.1-5.498 11.549-14.283 11.549-8.22 0-13.744-4.244-14.155-10.88z" />
    <Circle cx={119.864} cy={63.38} r={10.778} fill={props.primarycolor} />
    <Path d="M122.867 52.899a10.78 10.78 0 019.488 15.893 10.776 10.776 0 10-17.903-11.84 10.752 10.752 0 018.415-4.053z" fill={props.primarycolor} />
    <Circle cx={99.723} cy={31.696} r={31.661} fill={props.primarycolor} />
    <Path
      d="M74.874 12.052a31.656 31.656 0 0143.879-3.32c-.26-.246-.515-.494-.784-.733a31.661 31.661 0 00-42.072 47.325c.269.24.545.465.82.693a31.656 31.656 0 01-1.843-43.965z"
      fill={props.primarycolor}
    />
    <Path d="M130.254 112.406l4.87 27.599 5.682 54.386s1.624 21.916-5.682 22.728-5.682-24.352-5.682-24.352l-8.117-46.268-3.247-28.41z" fill="#fbbebe" />
    <Circle cx={100.22} cy={38.539} r={19.481} fill="#fbbebe" />
    <Path
      fill="#fbbebe"
      d="M84.797 46.656l-3.247 18.67 21.105 4.87V52.338l-17.858-5.682zM34.47 319.397l-2.435 16.234 9.741.812 5.682-13.799-12.988-3.247zM109.961 321.832l2.435 12.988h10.552v-12.176l-12.987-.812z"
    />
    <Path d="M117.266 140.005l-53.574 8.117-3.247 38.151-6.494 55.198-23.54 80.361 23.54 2.435 42.21-107.96 10.553 108.772h24.352l1.623-111.207s.812-61.691-12.176-65.75zM44.21 334.008l-13.799-2.435-5.682 27.599s-10.552 37.34 3.247 34.092 11.364-34.092 11.364-34.092zM109.96 334.008l13.8-2.435 5.682 27.599s10.553 37.34-3.247 34.092-11.364-34.092-11.364-34.092z" />
    <Path d="M42.587 100.23s-6.494 34.093-3.247 42.21 21.917 36.528 21.917 36.528l5.682-12.176-16.234-31.657 5.682-32.47z" fill="#fbbebe" />
    <Path d="M106.714 76.69l-1.624-12.176s-20.293-3.247-23.54-8.929l-5.682 9.74-18.67 4.06s-10.552 0-11.364 8.117-5.682 24.352-5.682 24.352l14.611 4.87 11.364 42.21 48.704-7.306-2.435-21.916 2.435-5.682 2.435 6.493 15.423-3.246s.812-29.223-14.61-34.093z" />
    <Path fill={props.primarycolor} d="M82.014 17.207v20.392h4.723l6.01-6.439-.805 6.439h20.875l-1.288-6.439 2.576 6.439h3.327V17.207H82.014z" />
    <Path d="M858.878 343.354h-3l1.5-71 1.5 71z" />
    <Path d="M858 334.354l-1.462-1.124 14.327-26.401L858 334.354z" />
  </Svg>
);
