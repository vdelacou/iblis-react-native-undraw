...
export const SvgPlaylist = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 886.102 518.697" style={props.style} width="100%" height={props.height} {...props}>
    <Path fill={props.accentcolor} d="M366.102 516.697h520v2h-520z" />
    <Circle cx={621.221} cy={36.546} r={11.954} fill={props.haircolor} />
    <Path d="M609.937 40.894a11.955 11.955 0 017.725-19.02 11.95 11.95 0 101.486 23.758 11.924 11.924 0 01-9.21-4.738z" fill={props.haircolor} />
    ...
    <Path d="M595.47 102.81s2.972 23.781-8.918 29.726 22.294 14.864 22.294 14.864l20.809-23.781s-10.404-13.377-7.432-22.295z" fill="#ffb8b8" />
    <Path
    ...
    />
    <Path d="M541.962 267.791l-4.459 19.322s-16.35 28.24-4.459 29.726 14.863-29.726 14.863-29.726l7.432-19.322z" fill="#ffb8b8" />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path fill={props.haircolor} d="M588.266 66.122v24.823h5.749l7.316-7.839-.98 7.839h25.411l-1.567-7.839 3.135 7.839h4.05V66.122h-43.114z" />
    <Path d="M631.157 83.024h3.016a6.41 6.41 0 016.41 6.409v.7a6.41 6.41 0 01-6.41 6.41h-3.016v-13.52z" fill={props.primarycolor} />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M587.28 98.775h-2.728a2.729 2.729 0 01-2.729-2.729V83.52a2.729 2.729 0 012.729-2.729h2.728v17.984z" fill={props.primarycolor} />
    <Path
