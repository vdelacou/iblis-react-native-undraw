...
export const SvgOnlineGroceries = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 769.924 727.778" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Path d="M649.01 309.86c-12.096 1.682-20.47 8.306-23.88 21.52l-22.234-41.05a12.155 12.155 0 013.874-15.436 12.155 12.155 0 0116.51 2.416z" fill={props.primarycolor} />
    <Path
    ...
    />
    <Path d="M550.332 458.919l-2.396 32.746a7.294 7.294 0 01-6.79 6.746 7.294 7.294 0 01-7.777-7.452l.763-32.04 23.823-90.53.953-55.27 26.682-.952-1.906 63.846z" fill="#a0616a" />
    <Path d="M588.45 316.931c-11.313-4.6-21.879-3.06-31.448 6.67l1.311-46.665a12.155 12.155 0 0111.083-11.422 12.155 12.155 0 0113.081 10.36z" fill={props.primarycolor} />
    <Path
    ...
    <Path
      ...
      fill={props.accentcolor}
    />
    <Path d="M186.567 139.329a5.56 5.56 0 11-11.121 0" opacity={0.2} />
    <Path
