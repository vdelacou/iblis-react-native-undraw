...
export const SvgTypewriter = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1009.54 717.96" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Typewriter_svg__a" x1={554.8} y1={808.98} x2={554.8} y2={548.41} gradientUnits="userSpaceOnUse">
    ...
    <G opacity={0.2}>
      ...
      />
      <Ellipse cx={322.94} cy={705.95} rx={13.02} ry={17.05} transform="rotate(-27.84 91.68 852.522)" fill={props.accentcolor} />
      <Ellipse cx={313.21} cy={687.53} rx={13.02} ry={17.05} transform="rotate(-27.84 81.944 834.092)" fill={props.accentcolor} />
      <Ellipse cx={303.48} cy={669.1} rx={13.02} ry={17.05} transform="rotate(-27.84 72.228 815.667)" fill={props.accentcolor} />
      <Ellipse cx={293.75} cy={650.68} rx={13.02} ry={17.05} transform="rotate(-27.84 62.487 797.258)" fill={props.accentcolor} />
      <Path
        ...
        fill={props.primarycolor}
      />
      <Path d="M205.35 438.44a62.12 62.12 0 016.21 40.33 62.38 62.38 0 11-86.7 45.78c-12.35-5.48 77.22-92.3 80.49-86.11z" opacity={0.1} />
    </G>
    <G opacity={0.2}>
      <Path
        ...
        fill={props.accentcolor}
      />
      <Ellipse cx={813.65} cy={566.75} rx={23.67} ry={18.08} transform="rotate(-70.04 701.07 589.192)" fill={props.accentcolor} />
      <Ellipse cx={823.53} cy={539.55} rx={23.67} ry={18.08} transform="rotate(-70.1 709.9 562.249)" fill={props.accentcolor} />
      <Ellipse cx={833.41} cy={512.36} rx={23.67} ry={18.08} transform="rotate(-70.04 720.826 534.807)" fill={props.accentcolor} />
      <Ellipse cx={843.28} cy={485.17} rx={23.67} ry={18.08} transform="rotate(-70.04 730.698 507.616)" fill={props.accentcolor} />
      <Path
        ...
        fill={props.primarycolor}
      />
      <Path d="M715.59 228.69a86.28 86.28 0 00-.86 56.67 86.61 86.61 0 10128 46.48c15.91-9.86-123.82-112.28-127.14-103.15z" opacity={0.1} />
    </G>
    <Ellipse cx={180.47} cy={642.47} rx={67.3} ry={12.94} fill={props.primarycolor} />
    <Ellipse cx={179.34} cy={636.97} rx={7.84} ry={10.26} fill={props.accentcolor} />
    <Ellipse cx={179.34} cy={624.43} rx={7.84} ry={10.26} fill={props.accentcolor} />
    <Ellipse cx={179.34} cy={611.89} rx={7.84} ry={10.26} fill={props.accentcolor} />
    <Ellipse cx={179.34} cy={599.36} rx={7.84} ry={10.26} fill={props.accentcolor} />
    <Ellipse cx={179.34} cy={586.82} rx={7.84} ry={10.26} fill={props.accentcolor} />
    <Ellipse cx={179.34} cy={574.28} rx={7.84} ry={10.26} fill={props.accentcolor} />
    <Ellipse cx={179.34} cy={561.75} rx={7.84} ry={10.26} fill={props.accentcolor} />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M141.64 499.15a37.34 37.34 0 008 23.21 37.53 37.53 0 1059 0c5.07-6.38-67-27.38-67-23.21z" opacity={0.1} />
    ...
    <Ellipse cx={275.91} cy={461.74} rx={15.31} ry={12.81} fill={props.primarycolor} />
    <Ellipse cx={275.91} cy={461.74} rx={15.31} ry={12.81} opacity={0.1} />
    <Ellipse cx={275.91} cy={458.93} rx={15.31} ry={12.81} fill={props.primarycolor} />
    ...
    <Ellipse cx={736.71} cy={461.74} rx={15.31} ry={12.81} fill={props.primarycolor} />
    <Ellipse cx={736.71} cy={461.74} rx={15.31} ry={12.81} opacity={0.1} />
    <Ellipse cx={736.71} cy={458.93} rx={15.31} ry={12.81} fill={props.primarycolor} />
    ...
    <Path d="M679.86 331.46c0 26.4-83.56 54.67-177.77 54.67s-164-30.46-164-56.86 69.81-38.74 164-38.74 177.77 14.53 177.77 40.93z" opacity={0.1} />
    ...
    <Path
      fill="#464353"
      d="M265.29 221.18h497.35v7.5H265.29zM521.77 230.55c-4.07-1.25-11.56 23.43-11.56 23.43h22.8s-7.17-22.18-11.24-23.43zm-.32 3.12a2.19 2.19 0 11-2.18 2.19 2.19 2.19 0 012.19-2.19zm.26 7.06c2.67.65 7.4 12.31 7.4 12.31h-15s4.94-12.97 7.66-12.31z"
    />
    <Path
    ...
    <G data-name="woman">
      ...
      <Path
        ...
        fill="#be6f72"
      />
      <Path d="M486.25 482.54l-4.4 1.57-1.6-2.66v-.23a7.7 7.7 0 015.47-1.08z" opacity={0.1} />
      <Path
      ...
      />
      <Path
        d="M431.38 602.55c-8.24-3.49-6.41-12-4.86-16.32a24.48 24.48 0 011.09-2.54l4.62-2.81s.94 2.41 1.95 5.64c2.34 7.46 5.03 19.35-2.8 16.03zM442.7 680.42a13.84 13.84 0 00-1.23 3.44 24.47 24.47 0 00-.51 5.85 22.3 22.3 0 00.15 2.25l-9.18 6.31s.05-.74.14-1.83c.24-2.89.73-8.25 1.2-8.94a15 15 0 00.69-4.22c.14-1.75.2-3.37.2-3.37s11.02-4.14 8.54.51zM464.36 684.98s0 1.75-.06 3.8a39 39 0 01-.44 5.57 22.25 22.25 0 00-.21 4.66c.06 2 .21 3.87.21 3.87s-9.37-8.85-8.42-9.55a4.43 4.43 0 00.75-2c.28-1.24.54-2.86.73-4.25.23-1.65.37-3 .37-3z"
        fill="#be6f72"
      />
      <Path
        d="M442.7 680.42a13.84 13.84 0 00-1.23 3.44 74.05 74.05 0 01-7.51-.58c.14-1.75.2-3.37.2-3.37s11.02-4.14 8.54.51zM464.36 684.98s0 1.75-.06 3.8c-2.92.74-5.92-.75-7.38-1.65.23-1.65.37-3 .37-3z"
        opacity={0.1}
      />
      <Path
      ...
      <Path
        ...
        opacity={0.1}
      />
      <Path d="M434.18 586.52a10.83 10.83 0 01-7.66-.29 24.48 24.48 0 011.09-2.54l4.62-2.81s.94 2.41 1.95 5.64z" opacity={0.1} />
      <Path
      ...
      />
      <Path
        d="M475.39 534.07s-2.21 19-8.67 22.6c.05 0 14.45-4.08 8.67-22.6zM442.93 535.77s8 3.91 6.12 6.62-6.12-6.62-6.12-6.62zM442.93 543.58s5.1 5.27 4.08 7.14-4.08-7.14-4.08-7.14zM484.06 499.91s2 3.4 2.18 5.61-2.18-5.61-2.18-5.61zM484.06 495.32s1-.85 3.56 0-3.56 0-3.56 0zM474.24 594.65a23.57 23.57 0 01-12.42-1.59l-2.15 5.48-.23-2.54c.35-2.13 1-4.41 2.38-5a20.57 20.57 0 0012.42 3.65zM439.39 601.79s10.45 2.19 13.38 1.78zM440.47 604.53s4.46-.19 6.69.7zM440.98 606.37a39 39 0 006.18.83zM440.77 629.76c.2-.13 8.93-2.16 10-.7zM440.77 632.44s7.59-.89 7.78 0-7.78 0-7.78 0zM440.77 634.86s8.1-1.66 9-1.27-9 1.27-9 1.27zM441.11 691.98l-9.18 6.31s.05-.74.14-1.83a25.17 25.17 0 014.7-7.67c2.07-.53 3.38 0 4.19.94a22.3 22.3 0 00.15 2.25z"
        opacity={0.1}
      />
      <Path
        ...
        fill="#35323e"
      />
      <Path d="M438.14 714.55a7.27 7.27 0 01-.64.92s-6.38 0-8.61-1.9c1.1-3.63 4.6-14.62 6.24-12.75s2.64 10.16 3.01 13.73z" opacity={0.1} />
      <Path d="M437.26 701.5l-.44 16.48h2.14s.34-14.44 1.3-16.46-3-.02-3-.02z" fill="#35323e" />
      <Path d="M463.86 702.85s-9.37-8.85-8.42-9.55a4.43 4.43 0 00.75-2c1.8-.32 4.88.44 7.46 7.63.06 2.05.21 3.92.21 3.92z" opacity={0.1} />
      <Path
        ...
        fill="#35323e"
      />
      <Path d="M465.03 712.8a65.22 65.22 0 01-7.43 0 1.61 1.61 0 01-1.56-1.6v-2.16c.69-3 1.68-6.18 3-6.89-.09-.01 3.78-.45 5.99 10.65z" opacity={0.1} />
      ...
      />
      <G opacity={0.1}>
        <Path d="M445.97 469.44v.47c-.01-.15 0-.31 0-.47zM475.65 485.78a43.09 43.09 0 00.45-6.49 42.91 42.91 0 00-.45 6.49zM440.25 496.53c-.23-2.53-1.41-4.91-1.69-7.42a9.18 9.18 0 00-.06 1.39c.1 2.76 1.47 5.33 1.74 8.08a10 10 0 00.01-2.05zM477.25 506.58a17.32 17.32 0 00-.42 5.07 15.67 15.67 0 01.42-2.94c.66-2.61 2.12-5.05 2.24-7.75a8.69 8.69 0 00-.07-1.44c-.3 2.46-1.57 4.67-2.17 7.06zM442.77 506.81a10.63 10.63 0 01-6 2.46c-.47.72-1 1.44-1.43 2.13a10.53 10.53 0 007.43-2.42 56.42 56.42 0 012.37 15.26 56.17 56.17 0 00-2.37-17.43zM477.35 529.37c-.45 2.29-1.42 4.83-3.62 5.6a6.12 6.12 0 00-1.58.59c-1 .71-.94 2.18-1.15 3.39a8 8 0 01-3.41 4.92 24 24 0 01-5.53 2.63l-7.63 2.86a10.44 10.44 0 01-.37 2.27l8-3a24 24 0 005.53-2.63 8 8 0 003.41-4.92c.21-1.22.15-2.69 1.15-3.4a6.49 6.49 0 011.58-.58c2.2-.78 3.17-3.32 3.62-5.6a32.39 32.39 0 00.57-7.22 33.46 33.46 0 01-.57 5.09zM449.54 536.06a2.76 2.76 0 00-.87-.65 2.9 2.9 0 00-1.1-.14h-3.33c-.13.71-.27 1.42-.43 2.12h3.76a2.9 2.9 0 011.1.14 2.61 2.61 0 01.87.65 16.12 16.12 0 014.85 9.55c.43-4.24-1.76-8.6-4.85-11.67z" />
      </G>
      <Path d="M430.89 549.98s3-1.28 3.72 0-3.72 0-3.72 0zM431.94 552.14s3-1.28 3.72 0-3.72 0-3.72 0z" opacity={0.1} />
    </G>
    <Path
    ...
    />
    <Path
      d="M369.22 199.04c.95.49 1.69.83 1.84.9.45.22 2.78-2.38 3.1-4.47s5.89-8.62 5.89-8.62a23.39 23.39 0 002.07-8.16c.21-2.85-1-3.07-2.37-2.43-.23 2.26-.8 6.65-2 8.94-1.34 2.72-6.98 11.47-8.53 13.84zM285.86 244.76a1.3 1.3 0 01-.08.17 11 11 0 00.61 1l8.82-2.71s-.51-2-1.28-4.36c-3.49-1-8.49 5.13-8.49 5.13z"
      opacity={0.1}
    />
    <Path
      ...
      fill="#ff6484"
    />
    <Path d="M285.3 251.33s7.35 2.58 10.67 2.18c2.51-.3 2.62-1.47 2.45-3.87a7.77 7.77 0 01-6 1.73 23.76 23.76 0 01-7.33-2.19 11.37 11.37 0 00.21 2.15z" opacity={0.1} />
    <Path
    ...
    />
    <Path
      d="M248.45 86.83l9.52-1.25h-.18a9.31 9.31 0 01-.9-.25l-5.23.17-3.28.11s.03.42.07 1.22zM259.12 122.51l4.13 1.01 6.49-.85 1.7-1.77-12.32 1.61zM265.98 124.19l1.87.46.77-.8-2.64.34z"
      fill="#925978"
    />
    <Path
    ...
    <Path
      ...
      fill="#444053"
    />
    <Path d="M247.61 70.62l2.15 6.45 4.12.36-.19-.16-2.06-9.58a4.48 4.48 0 00-3.26 1.87 9.16 9.16 0 01-.76 1.06z" fill="#444053" />
    <Path d="M216.59 58.77l.27 2.1 9.13 1.29s.75-.56 1.92-1.32c-1-.22-5.5-1.21-7.88-2-.87-.27-1.46-.5-1.48-.66s.06-.18.2-.3z" opacity={0.1} />
    <Path
      ...
      fill="#444053"
    />
    <Path d="M214.77 64.77l5.72.82a5.73 5.73 0 01.73-.41 2.23 2.23 0 002.93.66 6.52 6.52 0 001.7-1.58 21.55 21.55 0 001.57-2.44s-5.4-1.16-8.08-2z" opacity={0.1} />
    <Path d="M215.1 64.31l6.1.87a2.23 2.23 0 002.93.66c1.75-1 3.62-4.5 3.62-4.5s-5.39-1.15-8.08-2z" fill="#444053" />
    <Path
      d="M328.57 154.63l-10.15 7.68s4.59 2.37 8.87 5.12c3.74-2.53 7.27-4.86 9.94-7-3.56-1.21-8.66-5.8-8.66-5.8zM273.02 204.58a34.68 34.68 0 007.44-1.78s1.87-.41 4.65-1.34c-.08-1-.14-2.06-.15-3.31a68 68 0 00-1.39-10.66l-10.29 1.87-.27 11.49a7.7 7.7 0 00.01 3.73z"
      opacity={0.1}
    />
    <Path
    ...
    <Path
      ...
      fill="#f86d70"
    />
    <Path d="M320.05 58.19l1.66 6.71 2.16-1.3 11.7-7.07s8.86-.32 9.55-7.45-9.85-.07-10.41.48-1.84 1.49-1.84 1.49l-10.9 6.07z" fill="#efb7b9" />
    <Path
      d="M320.05 58.19l1.66 6.71 2.16-1.3c-.48-3-1.22-5.83-1.9-6.48zM262.28 102.07l2.38 14 14.12-3c-.34-1.07-4.53-14.6-1.5-17.94s2-13.24 2-13.24-5.48-6.31-6.58-7.83-8.22-2.72-8.22-2.72a5.8 5.8 0 01-.52-2 7.69 7.69 0 00-.54 1.49c0 2.56 1 4.31 3.77 5.6l.76.33c.43.17.9.33 1.4.49l.23.07c4.55 1.35 5.53 4.07 5.53 4.07a10.37 10.37 0 012.07 7.34c-.51 4.38-14.9 13.34-14.9 13.34z"
      opacity={0.1}
    />
    <Path
      ...
      fill="#444053"
    />
    <Path d="M320.03 57.1a1.43 1.43 0 01.51 0c1.59.49 3.66 14.25 2 15.51a6.39 6.39 0 01-2.79 1.21h-.24l-.53-4.59a3.24 3.24 0 00-.39.25v-.19a12 12 0 00-2.26-10.19z" opacity={0.1} />
    <Path
      d="M319 69.3l.53 4.59a6.43 6.43 0 003.44-1.28c1.64-1.26-.43-15-2-15.51-1.26-.39-3.47 1.18-4.35 1.85A11.92 11.92 0 01319 69.3zM268.77 76.69l2.28-2.15-6-5.79a7.1 7.1 0 00-.84 2c0 2.8 1.21 4.62 4.56 5.94z"
      fill="#444053"
    />
    <Path
      d="M252.77 49.28c.87.57 1.59 1.5 2.62 1.63a4.06 4.06 0 002.13-.53c1.73-.75 3.69-1.33 5.48-.74 2.55.85 4 3.78 6.49 4.65a4.53 4.53 0 003.8-.42 4.49 4.49 0 002-2.75 4.55 4.55 0 00.11-1.22 4.68 4.68 0 010 2 4.41 4.41 0 01-3.36 3.3 4.55 4.55 0 01-2.43-.13c-2.55-.87-3.95-3.8-6.49-4.65-1.79-.59-3.75 0-5.48.74a4.06 4.06 0 01-2.13.53c-1-.13-1.76-1.06-2.63-1.63-.14-1.12-3.16-.1-3.54-1.44a1.51 1.51 0 010-.61c.57 1.06 3.27.22 3.43 1.27zM262.14 80.89s-1.27 3.56.34 4.75c0 0-1.76-4.7-2.79-4.6"
      opacity={0.1}
    />
    ...
    <Ellipse cx={847.47} cy={692.13} rx={33.8} ry={6.5} fill={props.primarycolor} />
    <Ellipse cx={846.9} cy={689.37} rx={3.94} ry={5.15} fill={props.accentcolor} />
    <Ellipse cx={846.9} cy={683.07} rx={3.94} ry={5.15} fill={props.accentcolor} />
    <Ellipse cx={846.9} cy={676.77} rx={3.94} ry={5.15} fill={props.accentcolor} />
    <Ellipse cx={846.9} cy={670.48} rx={3.94} ry={5.15} fill={props.accentcolor} />
    <Ellipse cx={846.9} cy={664.18} rx={3.94} ry={5.15} fill={props.accentcolor} />
    <Ellipse cx={846.9} cy={657.88} rx={3.94} ry={5.15} fill={props.accentcolor} />
    <Ellipse cx={846.9} cy={651.59} rx={3.94} ry={5.15} fill={props.accentcolor} />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M827.97 620.15a18.83 18.83 0 004 11.66 18.85 18.85 0 1029.64 0c2.55-3.21-33.64-13.78-33.64-11.66z" opacity={0.1} />
  </Svg>
);
