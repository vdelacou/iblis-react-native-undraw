...
export const SvgChat = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 869 634.74" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
