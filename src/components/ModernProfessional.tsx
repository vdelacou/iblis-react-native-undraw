...
export const SvgModernProfessional = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 583.904 652" style={props.style} width="100%" height={props.height} {...props}>
    ...
    />
    <Path fill={props.haircolor} d="M315.501 650.549l-10-228 1.998-.098 10 228-1.998.098zM333.504 420.582l1.993-.165 19 230-1.994.165z" />
    <Path
    ...
    />
    <Path d="M263.5 384.5v10s-5 23 11 22 6-28 6-28l-1-9zM308.5 385.5s-11 23 0 25 19-13 19-17-19-8-19-8z" fill="#ffb8b8" />
    ...
    <Path d="M340.5 206.5s25 0 24 10-34 182-34 182-14-13-26-10zM243.5 209.5s-25 5-25 20 36 159 41 159 24-3 24-8-40-171-40-171z" fill={props.accentcolor} />
    <Path d="M249 239l22.5 87.991S261 250 249 239zM336.517 226.636L313.761 341.68s7.273-108.408 22.756-115.044z" opacity={0.2} />
