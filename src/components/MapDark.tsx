...
export const SvgMapDark = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1142.046 959.789" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="MapDark_svg__a" x1={535.451} y1={779.244} x2={535.451} y2={104.907} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.535} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="MapDark_svg__c" x1={873.186} y1={742.811} x2={873.186} y2={620.076} gradientUnits="userSpaceOnUse">
      ...
      <ClipPath id="MapDark_svg__b" transform="translate(-64.55 -7.924)">
        <Path fill={props.primarycolor} d="M889.286 734.556H724.703l-251.058 24.269-253.001-24.269V139.96l251.952 18.202 257.393-18.202 251.797 34.381v467.184l-92.5 93.031z" />
      </ClipPath>
    </Defs>
    <Path fill="url(#MapDark_svg__a)" d="M829.064 752.8H669.299l-272.121 26.444L122.951 752.8V104.907l273.09 19.833 278.988-19.833 272.922 37.463-7.006 497.539L829.064 752.8z" />
    ...
    <Path fill={props.primarycolor} d="M824.736 726.631H660.154l-251.058 24.27-253.001-24.27V132.035l251.952 18.202 257.393-18.202 251.797 34.382V633.6l-92.501 93.031z" />
