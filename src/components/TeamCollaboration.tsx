...
export const SvgTeamCollaboration = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1007.529 665.082" style={props.style} width="100%" height={props.height} {...props}>
    <Path fill={props.accentcolor} d="M83.401 188.773h21.846v28.4H83.401zM567.401 586.773h21.846v28.4h-21.846zM920.155 294.511v21.846h-28.4v-21.846z" />
    <Circle cx={847.031} cy={525.346} r={86.292} fill={props.haircolor} />
    <Path fill={props.haircolor} d="M880.36 643.515l25.796-4.67-8.367-53.864-25.796 4.67 8.367 53.864zM854.564 640.539l-25.796 4.67-8.367-46.218 25.796-4.67z" />
    <Ellipse cx={933.402} cy={766.142} rx={21.846} ry={8.192} transform="rotate(-40.261 725.063 838.684)" fill={props.haircolor} />
    <Ellipse cx={983.92} cy={764.643} rx={21.846} ry={8.192} transform="rotate(-40.261 775.58 837.185)" fill={props.haircolor} />
    ...
    />
    <Ellipse cx={863.588} cy={627.084} rx={13.545} ry={43.146} transform="rotate(-77.09 741.756 628.75)" fill={props.haircolor} />
    <Ellipse cx={1032.976} cy={655.253} rx={13.545} ry={43.146} transform="rotate(-77.09 911.144 656.918)" fill={props.haircolor} />
    <Path d="M870.731 559.353a19.662 19.662 0 11-38.694 7.004c-1.934-10.685 6.327-14.466 17.012-16.4s19.748-1.29 21.682 9.396z" fill="#fff" />
    ...
    <Path d="M738.608 535h-320V0h320zm-318-2h316V2h-316zM44.019 662.841h963.51v2.241H44.019z" fill={props.accentcolor} />
    <Path d="M699.608 281h-242V59h242zm-240-2h238V61h-238z" fill={props.accentcolor} />
    <Path fill={props.accentcolor} d="M459.315 222.139l-1.414-1.414 75.423-75.423 44.284 44.284L697.401 69.793l1.414 1.414-121.207 121.207-44.284-44.284-74.009 74.009z" />
    ...
    <Path fill={props.primarycolor} d="M578.175 469.09l-17.767-23.69 6.4-4.8 12.233 16.31 56.239-56.238 5.656 5.656-62.761 62.762z" />
    <Path
