...
export const SvgAgree = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1135.434 687.068" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path fill={props.primarycolor} d="M982.868 99.068l5-13 4 1 5-4 7-22 10 7 13 131-81 2 11-91 10-26 7.219-9.543 4.781 14.543 4 10z" />
    <Path
    ...
    <Path fill={props.accentcolor} d="M847.246 252.324l-17.768-23.689 6.401-4.801 12.232 16.31 56.239-56.238 5.657 5.656-62.761 62.762z" />
    <Path
