...
export const SvgAnalyze = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 825.211 661.163" style={props.style} width="100%" height={props.height} {...props}>
    <Ellipse cx={614.913} cy={645.163} rx={191} ry={16} fill={props.accentcolor} />
    <Path d="M804.913 466.181c0 78.406-46.61 105.782-104.108 105.782s-104.108-27.376-104.108-105.782 104.108-178.15 104.108-178.15 104.108 99.745 104.108 178.15z" fill="#f2f2f2" />
    <Path
    ...
    <Circle cx={235.118} cy={194.89} r={47.904} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    ...
    <Circle cx={804.455} cy={43.515} r={14.756} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Path fill={props.primarycolor} d="M683.913 51.83h33.333v33.333h-33.333z" />
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M690.58 45.163h33.333v33.333H690.58z" />
    ...
    <Path d="M674.413 250.663l6.248 10.44s2.752 19.56-11.248 19.56-34-19-34-19-10-4-16-3-39 0-25-17 38 0 38 0l25 12 13-7z" fill="#fbbebe" />
