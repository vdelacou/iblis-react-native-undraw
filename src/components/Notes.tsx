...
export const SvgNotes = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 910.74 527.39" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
    ...
    <Path fill="#e0e0e0" d="M127.24 96.04H357.3v8.68H127.24zM127.24 141.61H357.3v8.68H127.24zM127.24 187.19H357.3v8.68H127.24z" />
    ...
    <Path fill="#e0e0e0" d="M273.73 214.32h230.06V223H273.73zM273.73 259.9h230.06v8.68H273.73zM273.73 305.47h230.06v8.68H273.73z" />
    ...
    <Path fill="#dfdfdf" d="M420.23 332.6h230.06v8.68H420.23zM420.23 378.18h230.06v8.68H420.23zM420.23 423.76h230.06v8.68H420.23z" />
    <Path
      ...
      opacity={0.5}
    />
    <Path d="M820.15 452.27l-20.89 13.66-24.08 23.09a2.37 2.37 0 00-.34 3 2.37 2.37 0 003.28.69l48-31.36z" fill="#333" />
    <Path d="M776.98 205.1l-48.29 26.51a31.36 31.36 0 01-15.09 3.87h-58.16v-9.78l57.51-9.77s65.12-40.13 69.42-27.11-5.39 16.28-5.39 16.28z" fill={props.primarycolor} />
    <Path d="M828.85 304.94H748.7l12-55.34c0-30.12-6-65.89 24.13-65.89 30.12 0 26.87 20.58 26.87 50.69z" fill={props.primarycolor} />
    <Path d="M777.61 162.68h17.08v23.67a7.87 7.87 0 01-7.87 7.87h-1.34a7.87 7.87 0 01-7.87-7.87v-23.67z" fill="#fda57d" />
    ...
    <Path d="M817.13 257.19l-53.17 38 4.34 7.6 62.16-31.53a16.69 16.69 0 008.24-20.32c-7.41-21.5-21.57 6.25-21.57 6.25z" opacity={0.05} />
    <Path d="M802.83 213.42l17.54 44.85-54.24 31.43 5.43 14.11 62.16-31.53a16.69 16.69 0 008.24-20.32c-7.41-21.47-22.72-59.41-35.71-50.49a10 10 0 00-3.42 11.95z" opacity={0.05} />
    <Path
    ...
    <Path d="M655.44 225.7s-28.21 4.34-27.13 8.68 27.13 1.09 27.13 1.09zM766.85 292.12s-25.25 13.32-22.8 17.07 26-7.84 26-7.84z" fill="#fda57d" />
