...
export const SvgCircuit = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 978 813.634" style={props.style} width="100%" height={props.height} {...props}>
    <Path
    ...
    <Path d="M313.483 462.596a12 12 0 1112-12 12.014 12.014 0 01-12 12zm0-22a10 10 0 1010 10 10.011 10.011 0 00-10-10z" fill={props.haircolor} />
    <Path d="M270.31 151.886h-19.74v-19.741h19.74zm-18.222-1.519h16.704v-16.704h-16.704z" fill={props.accentcolor} />
    <Path d="M71.955 296.966L58.49 282.53l14.436-13.465L86.39 283.5zm-11.319-14.361L72.03 294.82l12.215-11.394-11.394-12.215z" fill={props.haircolor} />
