...
export const SvgAbstract = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1095.74 664.034" style={props.style} width="100%" height={props.height} {...props}>
    ...
    />
    <Path fill={props.primarycolor} d="M610.5 578h-72.017l36.009-62.369.25-.433-13.242-22.935-36.008 62.368L489.483 617h144.034L611 578h-.5z" />
    <Path fill="#d0cde1" d="M159 345v-54h27v-32H52v134h134v-48h-27z" />
    <Path fill={props.primarycolor} d="M89 234h50v50H89z" />
    <Path d="M937.032 239.849l-16.544 43.723-59.664 20.935s-36-4-36 16c0 14.18 43 2 43 2l78.662-23.572 24.816-61.45z" fill="#ffb8b8" />
    ...
    />
    <Path d="M972.024 211.438s-16.544-2.364-24.816 28.36-10.635 33.089-10.635 33.089 48.45 7.09 49.632 4.727 10.635-59.086-14.181-66.176z" fill={props.haircolor} />
    ...
    />
    <Path d="M947.208 269.342l-16.544 43.723L871 334s-36-4-36 16c0 14.18 43 2 43 2l78.662-23.573 24.816-61.449z" fill="#ffb8b8" />
