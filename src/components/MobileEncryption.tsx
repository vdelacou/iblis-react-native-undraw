...
export const SvgMobileEncryption = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg viewBox="0 0 874.576 673.081" style={props.style} width="100%" height={props.height} {...props}>
    <G data-name="Group 14" transform="translate(-203 -155.811)">
      ...
      <G data-name="Group 11" transform="translate(746.713 292.765)">
        ...
        />
        <Path data-name="Path 67" d="M56.473 70.079s7.148 27.164 5 30.738 20.73 22.875 20.73 22.875l22.16-4.289 1.43-30.738S85.777 71.509 90.067 58.642z" fill={props.skincolor} />
        <Path data-name="Path 68" d="M56.473 70.079s7.148 27.164 5 30.738 20.73 22.875 20.73 22.875l22.16-4.289 1.43-30.738S85.777 71.509 90.067 58.642z" opacity={0.1} />
        <Path
          data-name="Path 69"
        ...
        <Path
          ...
          fill={props.accentcolor}
        />
        <Circle data-name="Ellipse 12" cx={29.666} cy={29.666} transform="translate(38.959 19.686)" fill={props.skincolor} r={29.666} />
        <Path
          data-name="Path 72"
        ...
        <Path data-name="Path 77" d="M22.16 112.972l-6.433-.714L0 196.608l27.164 84.351 23.59-17.871-16.441-56.472 5.718-43.605z" fill="#e6e6e6" />
        <Path
          data-name="Path 78"
        ...
        <Path data-name="Path 81" d="M124.382 120.836s-9.293-28.594-20.73-23.59 4.289 35.027 4.289 35.027l10.008 6.434z" fill={props.skincolor} />
        <Path data-name="Path 82" d="M173.706 157.293l-50.039-39.316-17.871 26.45s47.179 50.039 57.9 40.031 10.01-27.165 10.01-27.165z" fill="#e6e6e6" />
      </G>
      ...
      <Path
        ...
        fill="#d0cde1"
      />
      <Circle data-name="Ellipse 14" cx={2.178} cy={2.178} transform="translate(717.106 222.058)" fill={props.accentcolor} r={2.178} />
      <Circle data-name="Ellipse 15" cx={2.178} cy={2.178} transform="translate(725.092 222.058)" fill={props.accentcolor} r={2.178} />
      <Circle data-name="Ellipse 16" cx={2.178} cy={2.178} transform="translate(733.079 222.058)" fill={props.accentcolor} r={2.178} />
