...
export const SvgSynchronize = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 874.169 657" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path d="M627.5 536s12 3 12-6 5-5 5-5 12 7 7 14-14 15-17 22-12 26-22 22-3-13-3-13 8-12 6-22-3-15 0-15 8-3 8 1 4 2 4 2z" fill={props.haircolor} />
    ...
    <Path
      ...
      fill="#a0616a"
    />
    <Path d="M204.5 509s-14-12-11-14 15-16 21-8 33 52 26 62-12 4-12 4-18.598-25-25.8-25c0 0 9.8-11 1.8-19z" fill={props.haircolor} />
    <Path d="M104.5 584s1 33-8 43 12 8 12 8l22-15s-6-16-4-31z" fill="#a0616a" />
    <Path d="M130.5 612s-2-2-7 4-15 13-21 7-6-1-6-1-13 21-24 24-3 13 7 9 59-21 59-21-1-14-8-22z" fill={props.haircolor} />
    ...
    <Path d="M74.007 443.051c.142 18.341 2.337 36.372 9.493 43.949 0 0 10 27 10 37s7 70 7 70h29s6-83-10-109v-37.13" opacity={0.1} />
    <Path d="M105.5 352l-30 79s-18 68 4 75 79 5 88 12 14-21 11-24-51-19-71-19c0 0 53-72 40-88s-31-36-42-35z" fill={props.haircolor} />
    ...
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M829.174 470.352a20.788 20.788 0 0114.98-13.198l1.714 10.184 3.177-10.696a20.81 20.81 0 11-19.87 13.71z" fill="#57b894" />
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M844.768 580.368a20.81 20.81 0 0018.419-37.023l-2.441 8.22-1.731-10.304a.363.363 0 00-.053-.02 20.811 20.811 0 10-14.194 39.127z" fill="#57b894" />
    <Path
      ...
      strokeMiterlimit={10}
    />
    <Path d="M823.1 614.93a20.801 20.801 0 104.012-16.297l9.272 13.957-12.67-7.408a20.616 20.616 0 00-.613 9.748z" fill="#57b894" />
    <Path d="M823.958 612.173a20.801 20.801 0 104.01-16.298l9.273 13.957-12.67-7.408a20.616 20.616 0 00-.613 9.749z" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} />
  </Svg>
);
