...
export const SvgAppreciation = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 933.099 737.161" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Appreciation_svg__a" x1={611.671} y1={818.58} x2={611.671} y2={81.42} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.535} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="Appreciation_svg__b" x1={872.969} y1={716.168} x2={872.969} y2={344.73} xlinkHref="#Appreciation_svg__a" />
    </Defs>
    <Path
    ...
    />
    <Path d="M759.182 323.928a109.605 109.605 0 00-189.26 110.605l110.605 189.26 189.26-110.605a109.605 109.605 0 10-110.605-189.26z" fill="#e53935" />
    ...
    />
    <Path d="M230.731 355.21A123.813 123.813 0 0016.936 480.153L141.88 693.948l213.795-124.943A123.813 123.813 0 00230.731 355.21z" fill="#e53935" />
    <Path
