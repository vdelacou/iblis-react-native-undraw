...
export const SvgLocationTracking = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 884.596 679.043" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path d="M72.767 640.875v10s-23 22-4 22 20-5 20-5 7 0 7-2v-24zM178.767 640.875v10s23 22 4 22-20-5-20-5-7 0-7-2v-24z" fill={props.haircolor} />
