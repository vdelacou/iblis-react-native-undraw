...
export const SvgMessages = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 664 779.55" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Messages_svg__a" x1={324.23} y1={775.01} x2={630.7} y2={51.33} gradientTransform="rotate(-.14 -841.696 5577.13)" gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="Messages_svg__b" x1={557.77} y1={856.45} x2={863.06} y2={135.54} xlinkHref="#Messages_svg__a" />
      <LinearGradient id="Messages_svg__c" x1={430.18} y1={453.24} x2={430.18} y2={294.18} xlinkHref="#Messages_svg__a" />
    </Defs>
    <G opacity={0.5}>
      <Path
      ...
      />
      <Rect x={274.12} y={60.65} width={381.44} height={688.5} rx={13.64} ry={13.64} transform="rotate(-.14 -24317.39 110051.963)" fill="#fff" />
      <Path
        ...
        fill="#bbb"
      />
      <Rect x={418.12} y={86.18} width={85} height={5.31} rx={2} ry={2} transform="rotate(-.86 -3684.913 17913.26)" fill="#dbdbdb" />
      ...
      <Path d="M92.54 142.51H63.45a8.67 8.67 0 00-7.08 3.76 43.63 43.63 0 0043 .24 8.66 8.66 0 00-6.83-4z" fill={props.primarycolor} />
      ...
      <Path d="M72.21 136.73h11.63v4.52a5.34 5.34 0 01-5.34 5.34h-1a5.34 5.34 0 01-5.34-5.34v-4.52h.05z" opacity={0.1} />
      ...
      <Path d="M72.24 138.13a16.73 16.73 0 0011.63 0v-1.35H72.24z" opacity={0.1} />
    ...
    />
    <Rect x={507.27} y={141.27} width={381.44} height={688.5} rx={13.64} ry={13.64} transform="rotate(-.14 -24084.214 110134.099)" fill="#fff" />
    <Path
      data-name="&lt;Path&gt;"
    ...
    <Path fill="url(#Messages_svg__c)" d="M196.37 294.18H664v159.07H196.37z" opacity={0.5} />
    <Path fill="#fff" d="M201.94 300.72h456.5V447.8h-456.5z" />
    <Path fill={props.primarycolor} d="M384 355.19h177.59v14.16H384zM384 383.52h177.59v14.16H384z" />
    ...
    <Path d="M310.44 394.18h-29.1a8.67 8.67 0 00-7.08 3.76 43.63 43.63 0 0043 .24 8.66 8.66 0 00-6.82-4z" fill={props.primarycolor} />
    ...
    <Path d="M290.11 388.41h11.63v4.52a5.34 5.34 0 01-5.34 5.34h-1a5.34 5.34 0 01-5.34-5.34v-4.52h.05z" opacity={0.1} />
    ...
    <Path d="M290.13 389.78a16.73 16.73 0 0011.63 0v-1.43h-11.63z" opacity={0.1} />
