...
export const SvgFashionBlogging = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1129 663" style={props.style} width="100%" height={props.height} {...props}>
    ...
    />
    <Path d="M949.33 117.5H152.67A21.67 21.67 0 00131 139.17v38.33h840v-38.33a21.67 21.67 0 00-21.67-21.67z" fill={props.primarycolor} opacity={0.2} />
    ...
    <Path d="M315.872 487.407s80.385-9.347 76.646-24.302-31.78-31.78-31.78-31.78l-46.735 9.347-30.618 33.135 11.924 6.123z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M946.188 277.36a91.013 91.013 0 0019.562 56.514 91.406 91.406 0 10143.689 0c12.25-15.553-163.25-66.774-163.25-56.515z" opacity={0.1} />
  </Svg>
);
