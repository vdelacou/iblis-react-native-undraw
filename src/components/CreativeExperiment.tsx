...
export const SvgCreativeExperiment = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 974 757.15" style={props.style} width="100%" height={props.height} {...props}>
    ...
    />
    <Path d="M475.225 199.225L459.67 183.67a65.983 65.983 0 01-86.6 5.872l-13.316 17.52a87.998 87.998 0 00115.472-7.836z" fill="#575a89" />
    <Path d="M347 137a66 66 0 0166-66V49a88 88 0 00-53.247 158.061l13.316-17.52A65.885 65.885 0 01347 137z" fill={props.primarycolor} />
    <Path d="M578.122 576.9A50.122 50.122 0 01528 526.778V468.4c0-116.808 94.692-211.5 211.5-211.5S951 351.592 951 468.4v45.894a62.606 62.606 0 01-62.606 62.606" fill="#f2f2f2" />
    <Path
    ...
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M788.279 400.045l40.751-28.97 28.971 40.75-40.751 28.972z" />
    ...
    <Path fill={props.primarycolor} d="M687.934 425.82l25.134 14.467 25.133 14.467-25.096 14.533-25.095 14.533-.038-29-.038-29z" />
    <Path
      fill="none"
    ...
    />
    <Path d="M208.758 439.662s29.699-1.2 39.168 9.277-37.202 2.897-39.842-.054.674-9.223.674-9.223z" fill={props.skincolor} />
    <Path
    ...
    <Path d="M152.89 213.5s-15.774 24.478-11.967 31.005-40.251-6.527-40.251-6.527 26.653-32.637 26.109-36.444S152.89 213.5 152.89 213.5z" fill={props.skincolor} />
    <Path
