...
export const SvgServices = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 939.033 827.5" style={props.style} width="100%" height={props.height} {...props}>
    <Path
    ...
    <Path
      ...
      fill={props.accentcolor}
    />
    <Path fill={props.accentcolor} d="M131.933 499h308.2v2h-308.2zM111.033 582h350v2h-350zM131.933 665h308.2v2h-308.2z" />
    <Circle cx={764.033} cy={326} r={175} fill={props.primarycolor} />
    <Path fill={props.accentcolor} d="M466.033 291.54h2v250.92h-2zM527.033 252.93h2v328.14h-2zM588.033 242h2v350h-2zM649.033 252.93h2v328.14h-2zM710.033 291.54h2v250.92h-2z" />
    <Path fill={props.accentcolor} d="M434.933 333h308.2v2h-308.2zM414.033 416h350v2h-350zM434.933 499h308.2v2h-308.2z" />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Path d="M811 379.975l-143.285 5.441s-6.54 48.971 0 48.971c1.814 0 150.54 12.696 148.726-9.069s-5.442-45.343-5.442-45.343z" fill={props.accentcolor} />
    ...
    <Path d="M524.255 417.974H121.033V240.707h330.1l.278.677zm-401.033-2.189h397.763l-71.318-172.89H123.222z" fill={props.accentcolor} />
    <Path fill={props.accentcolor} d="M223.892 295.419h178.361v16.414H223.892zM223.892 329.34h178.361v16.414H223.892zM223.892 363.262h178.361v16.414H223.892z" />
    <Path d="M12 586.346a12 12 0 1112-12 12.014 12.014 0 01-12 12zm0-22a10 10 0 1010 10 10.011 10.011 0 00-10-10z" fill={props.haircolor} />
    <Path d="M433.828 134.636h-19.742v-19.741h19.742zm-18.223-1.519h16.704v-16.704h-16.704z" fill={props.accentcolor} />
    <Path d="M60.472 138.716L47.006 124.28l14.437-13.465 13.465 14.436zm-11.32-14.361l11.394 12.215 12.216-11.394-11.394-12.215z" fill={props.haircolor} />
  </Svg>
);
