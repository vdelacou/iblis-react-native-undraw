...
export const SvgSetup = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 907.03 730" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
    ...
    <Circle cx={423.15} cy={365} r={363} fill="none" stroke="#64ffda" strokeMiterlimit={10} strokeWidth={4} strokeDasharray="12.07 15.09" />
    ...
    <Path fill="#fff" d="M529.17 582.01l-9.82-7.49-25.88 33.91-14.44-11.02-7.49 9.81L490.9 622l.05-.07 4.9 3.74 33.32-43.66z" />
  </Svg>
);
