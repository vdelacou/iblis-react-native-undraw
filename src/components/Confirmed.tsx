...
export const SvgConfirmed = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 722 756.57" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Confirmed_svg__a" x1={635.65} y1={790.5} x2={635.65} y2={501.26} gradientTransform="translate(.01 -.01)" gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="Confirmed_svg__b" x1={457.34} y1={294.83} x2={457.34} y2={145.49} xlinkHref="#Confirmed_svg__a" />
      <LinearGradient id="Confirmed_svg__c" x1={591.52} y1={654.18} x2={591.52} y2={72.22} gradientTransform="translate(-238.99 -72.23)" xlinkHref="#Confirmed_svg__a" />
      <LinearGradient id="Confirmed_svg__d" x1={771.88} y1={599.91} x2={771.88} y2={322.65} xlinkHref="#Confirmed_svg__a" />
      <LinearGradient id="Confirmed_svg__e" x1={683.94} y1={827.36} x2={683.94} y2={758.36} gradientTransform="translate(-238.99 -72.23)" xlinkHref="#Confirmed_svg__a" />
      <LinearGradient id="Confirmed_svg__f" x1={432.87} y1={501.19} x2={432.87} y2={377.79} xlinkHref="#Confirmed_svg__a" />
      <LinearGradient id="Confirmed_svg__g" x1={428.07} y1={603.48} x2={428.07} y2={493.95} xlinkHref="#Confirmed_svg__a" />
      <LinearGradient id="Confirmed_svg__h" x1={352.52} y1={380.93} x2={352.52} y2={201.04} xlinkHref="#Confirmed_svg__a" />
      <LinearGradient id="Confirmed_svg__i" x1={442.05} y1={399.65} x2={442.05} y2={262.62} xlinkHref="#Confirmed_svg__a" />
    </Defs>
    <Circle cx={361} cy={395.57} r={297} fill="none" stroke="#3ad29f" strokeMiterlimit={10} strokeWidth={2} strokeDasharray={12} />
    <Circle cx={361} cy={395.57} r={360} fill="none" stroke="#3ad29f" strokeMiterlimit={10} strokeWidth={2} strokeDasharray={12} />
    <Path
    ...
    <Rect x={191.32} width={322.42} height={581.96} rx={12.25} ry={12.25} fill="url(#Confirmed_svg__c)" />
    ...
    <Path
      ...
      transform="translate(-239 -72.21)"
      fill="url(#Confirmed_svg__g)"
    />
    <Circle cx={352.52} cy={290.99} r={89.94} fill="url(#Confirmed_svg__h)" opacity={0.5} />
