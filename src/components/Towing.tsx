...
export const SvgTowing = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1002.501 516.22" style={props.style} width="100%" height={props.height} {...props}>
    <Path
    ...
    <Path d="M1002.5 493.693C983.741 525.03-.99 522.4.502 493.691c18.757-31.335 1003.488-28.704 1001.996.002z" fill="#d0cde1" />
    ...
    <Path fill="#fff" d="M678.577 279.146h53.286v53.286h-53.286zM771.827 333.038h-33.909v-53.286h14.533l19.376 53.286z" />
    <Path
    ...
    <Path fill={props.accentcolor} d="M297.097 397.829h365.736v10.899H297.097zM101.372 437.83l398.86-108.514 2.861 10.517-398.86 108.514z" />
    <Path fill={props.accentcolor} d="M466.176 347.557l6.831-5.02 41.959 57.096-6.83 5.02zM743.368 335.46h12.11v4.844h-12.11z" />
    <Path
    ...
    <Path fill="#fff" d="M294.724 254.884l-105.1 29.418-8.855-31.637 67.028-18.762 46.927 20.981zM126.075 267.974l41.825-11.707 8.855 31.637-41.825 11.707z" />
    <Path fill={props.accentcolor} d="M196.229 307.895l5.362-1.5 2.851 10.188-5.362 1.5zM286.014 267.151l1.501 5.362-10.188 2.852-1.501-5.362z" />
    <Path
