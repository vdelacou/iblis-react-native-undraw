...
export const SvgPodcast = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1140.21 776" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="Podcast_svg__a" x1={623.53} y1={767.89} x2={623.53} y2={127.97} gradientUnits="userSpaceOnUse">
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path fill={props.primarycolor} opacity={0.1} d="M516.27 150.21h318v22h-318zM516.27 245.21h318v22h-318zM516.27 344.21h318v22h-318zM544.27 93.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M544.27 102.21h20v4h-20zM544.27 133.21h20v4h-20zM574.27 93.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M574.27 102.21h20v4h-20zM574.27 133.21h20v4h-20zM604.27 93.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M604.27 102.21h20v4h-20zM604.27 133.21h20v4h-20zM634.27 93.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M634.27 102.21h20v4h-20zM634.27 133.21h20v4h-20zM664.27 93.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M664.27 102.21h20v4h-20zM664.27 133.21h20v4h-20zM694.27 93.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M694.27 102.21h20v4h-20zM694.27 133.21h20v4h-20zM724.27 93.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M724.27 102.21h20v4h-20zM724.27 133.21h20v4h-20zM714.552 294.674l17.878-8.964 25.55 50.953-17.88 8.965z" />
    <Path
      fill={props.primarycolor}
      opacity={0.1}
    ...
    />
    <Path fill={props.primarycolor} opacity={0.1} d="M544.27 198.21h20v4h-20zM544.27 229.21h20v4h-20zM574.27 189.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M574.27 198.21h20v4h-20zM574.27 229.21h20v4h-20zM604.27 189.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M604.27 198.21h20v4h-20zM604.27 229.21h20v4h-20zM729.27 189.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M729.27 198.21h20v4h-20zM729.27 229.21h20v4h-20zM759.27 189.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M759.27 198.21h20v4h-20zM759.27 229.21h20v4h-20zM789.27 189.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M789.27 198.21h20v4h-20zM789.27 229.21h20v4h-20zM544.27 287.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M544.27 296.21h20v4h-20zM544.27 327.21h20v4h-20zM574.27 287.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M574.27 296.21h20v4h-20zM574.27 327.21h20v4h-20zM604.27 287.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M604.27 296.21h20v4h-20zM604.27 327.21h20v4h-20zM634.27 287.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M634.27 296.21h20v4h-20zM634.27 327.21h20v4h-20zM664.27 287.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M664.27 296.21h20v4h-20zM664.27 327.21h20v4h-20zM694.27 287.21h20v57h-20z" />
    <Path fill={props.primarycolor} opacity={0.1} d="M694.27 296.21h20v4h-20zM694.27 327.21h20v4h-20zM774.27 98.29v51.92h-20V94.48q10.04 1.77 20 3.81z" />
    <Path
      fill={props.primarycolor}
      opacity={0.1}
    ...
    />
    <Path d="M804.27 105.23v1h-20v-4h7.78q6.14 1.42 12.22 3zM784.27 133.21h20v4h-20z" fill={props.primarycolor} opacity={0.1} />
    ...
    <Path d="M858.43 558.37s14.43-49-2.71-85.07a77.4 77.4 0 01-6.26-48.56 130.18 130.18 0 016.88-22.79" fill="none" stroke="#535461" strokeMiterlimit={10} strokeWidth={2} />
    <Path
    ...
    <Path
      ...
      fill="#fdc2cc"
    />
    <Path d="M353.79 238.63q-2.26 10.53-3.4 19.35a75.41 75.41 0 01-20.68 2.88 74.64 74.64 0 01-36.76-9.61 218.52 218.52 0 00-4-44.1z" opacity={0.1} />
    ...
    <Path d="M340.16 581.31l225.69-23.19 2.78 44.45-103.16 10.23a67.38 67.38 0 01-21.22-1.65l-104.28-26.94a1.48 1.48 0 01.19-2.9z" opacity={0.2} />
    ...
    <Path d="M394.11 582l120.32-12.26 1.47 23.5-54.55 4.43a35.63 35.63 0 01-11.22-.87l-56.12-13.27a.78.78 0 01.1-1.53z" fill="#fff" opacity={0.3} />
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M395.7 378.11l-5.8 42-13.07 25.48a79.68 79.68 0 00-24.82-2.33c9.21-1.27 15.16-58.82 15.16-58.82l.53-.12z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M404.72 312.71l-9 65.4-4.24 30.74c-12.42-.93-27.48-2.6-27.48-2.6s15.74-65.75-10.19-100c0 0 .55 0 1.54-.1 14.55 24.18 49.37 6.56 49.37 6.56z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M454.73 557.19c-21.3 25-130.57 19.45-130.57 19.45l-40.75 11.11-114.83 33.33c-.5-.65-1-1.31-1.46-2L434.35 540c17.06 3.44 27.53 8.8 20.38 17.19z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      fill="#ec7580"
    />
    <Path d="M299.11 422c-10.19-16.67-63.9-1.85-63.9-1.85s-25.93 7.41-31.49-6.48S158.4 409 158.4 409s-28.85 10.82-35.83.44l6.2-14.33 154.87-10.61z" opacity={0.1} />
    <Path
    ...
    <Path d="M232.94 418.74a2.78 2.78 0 01-4.55 2.14 42.24 42.24 0 013.81-4 2.72 2.72 0 01.74 1.86z" opacity={0.1} />
    ...
    <Path d="M232.94 539.13a2.77 2.77 0 01-1.89 2.63 45.66 45.66 0 01-3.39-3.82 2.77 2.77 0 015.28 1.19z" opacity={0.1} />
    ...
    <Path d="M296.76 420.88a2.78 2.78 0 01-4.55-2.14 2.72 2.72 0 01.74-1.88c.36.32.71.67 1.06 1 .96.98 1.87 1.98 2.75 3.02z" opacity={0.1} />
    ...
    <Path d="M297.49 537.93a45.65 45.65 0 01-3.39 3.82 2.78 2.78 0 113.39-3.82z" opacity={0.1} />
    ...
    <Path d="M792.37 553s10.09 27.33 9.25 34.48l8-.84s-13.51-23.97-10.1-33.64z" fill={props.primarycolor} />
    <Path d="M792.37 553s10.09 27.33 9.25 34.48l8-.84s-13.51-23.97-10.1-33.64z" opacity={0.2} />
    <Path d="M833.56 555.28s-15.88-8.12-23-1.41-8.2 23.86-8.2 23.86 25.91 3.57 31.2-22.45z" fill={props.primarycolor} />
    <Path d="M833.56 555.28s-15.88-8.12-23-1.41-8.2 23.86-8.2 23.86 25.91 3.57 31.2-22.45z" fill="#fff" opacity={0.1} />
    <Path d="M802.37 577.73s4.17-19.91 31.19-22.45" fill="none" stroke={props.primarycolor} strokeMiterlimit={10} />
  </Svg>
);
