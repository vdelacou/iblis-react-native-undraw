...
export const SvgDecide = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 862.674 714.509" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M1.071 712.782h860.531M1.071 1h860.531" />
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M861.674 2.447L539.446 132.578v444.095L861.674 713V2.447z" />
    <Path fill="none" stroke="#fff" strokeMiterlimit={10} strokeWidth={2} d="M566.299 481.657l231.342 53.705M566.299 446.543l231.342 35.114M566.299 409.363l231.342 24.786" />
    <Path fill={props.primarycolor} d="M768.724 283.285v53.704l-185.901-12.393v-41.311h185.901z" />
    <Path opacity={0.2} d="M768.724 283.285v53.704l-185.901-12.393v-2.066l181.769 10.328v-49.573h4.132z" />
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M1 2.447l322.227 130.131v444.095L1 713V2.447z" />
    <Path fill="none" stroke="#fff" strokeMiterlimit={10} strokeWidth={2} d="M296.375 481.657L65.032 535.362M296.375 446.543L65.032 481.657M296.375 409.363L65.032 434.149" />
    <Path fill={props.primarycolor} d="M93.95 283.285v53.704l185.901-12.393v-41.311H93.95z" />
    <Path opacity={0.2} d="M93.95 283.285v53.704l185.901-12.393v-2.066l-181.77 10.328v-49.573H93.95z" />
    <Path fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M353.249 168.533l161.61 1.988" />
    <Path
    ...
    />
    <Circle cx={434.054} cy={169.527} r={13.523} fill={props.accentcolor} />
    <Path
    ...
    <Path
      ...
      fill={props.haircolor}
    />
    <Path d="M404.906 433.11s-11.064 29.503-1.23 29.503 15.982-8.605 23.358-6.146 29.504-28.275 29.504-28.275z" fill={props.accentcolor} />
    <Circle cx={451.006} cy={289.892} r={19.669} fill={props.skincolor} />
    <Path d="M460.84 296.04s-8.605 28.274-6.146 31.962-23.357-1.23-23.357-1.23 8.605-23.357 7.376-28.274 22.128-2.459 22.128-2.459z" fill={props.skincolor} />
    <Path
    ...
    />
    <Path fill={props.skincolor} d="M436.869 436.797l4.917 12.294 11.064-8.606-1.229-8.605-14.752 4.917z" />
    <Path
