...
export const SvgFittingPiece = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1046 572.19" style={props.style} width="100%" height={props.height} {...props}>
    <Circle cx={923} cy={333.19} r={123} fill="#f2f2f2" />
    <Circle cx={903} cy={315.19} r={123} fill={props.primarycolor} />
    <Path fill={props.accentcolor} d="M715.73 569.865h158.412v1.875H715.73z" />
    <Path
    ...
    <Path
      ...
      fill={props.accentcolor}
    />
    <Path d="M876 572H0V0h876zM2 570h872V2H2z" fill={props.accentcolor} />
    <Path
    ...
    <Path fill="#ffb8b8" d="M434.941 142.69l-2 20-16 9 42 93 32-77-21-16-2-38-33 9z" />
    <Path
      ...
      fill={props.haircolor}
    />
    <Circle cx={463.941} cy={46.69} r={18} fill={props.haircolor} />
    <Path d="M462.94 56.69a17.99 17.99 0 01-6.333-34.832 17.99 17.99 0 108.667 34.664 18.071 18.071 0 01-2.333.168z" fill={props.haircolor} />
    <Ellipse cx={469.441} cy={116.19} rx={4.5} ry={6.5} fill="#ffb8b8" />
    <Path d="M371.44 237.19l-3 40s-14 22-17 69l-1 29s-21 41-4 40 16-39 16-39l30-87v-42z" fill="#ffb8b8" />
    <Path d="M389.44 178.19h-7s-11 7-20 37-10 31-10 31l47 11z" fill={props.haircolor} />
    ...
    />
    <Circle cx={27} cy={21} r={10} fill={props.primarycolor} />
    <Circle cx={57} cy={21} r={10} fill={props.primarycolor} />
    <Circle cx={87} cy={21} r={10} fill={props.primarycolor} />
    <Path fill="#d0cde1" d="M480.261 498.224h179.127v2.013H480.261z" />
    <Path fill={props.primarycolor} d="M472 360h108v108H472z" />
    <Path d="M493 444v-84h-2v86h89v-2z" fill="#d0cde1" />
    <Path d="M535.44 234.19l16 39s17 20 20 42l5 26s12 46-7 44-14-46-14-46l-3-13-17-28-25.084-47.68z" fill="#ffb8b8" />
    <Path fill={props.haircolor} d="M504.441 192.19l13 4 28 42-51 34 10-80z" />
    <Circle cx={532} cy={403} r={25} fill="#d0cde1" />
    <Circle cx={526} cy={357} r={19} fill={props.primarycolor} />
    <Circle cx={580} cy={410} r={19} fill={props.primarycolor} />
  </Svg>
);
