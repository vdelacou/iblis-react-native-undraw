...
export const SvgAtHome = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 840.5 427.813" style={props.style} width="100%" height={props.height} {...props}>
    <Ellipse cx={180.872} cy={328.665} rx={29.099} ry={59.374} fill="#e6e6e6" />
    <Path d="M183.56 425.851c-11.655-69.925-.118-139.598 0-140.293l2.267.384c-.117.692-11.588 69.999 0 139.532z" fill={props.accentcolor} />
    <Path
    ...
    />
    <Path fill={props.accentcolor} d="M799.25 138l-116-138-232.846 2.129-141.248 137.578 2.854 1.835h-1.019v286.164h487.946V141.542l.313-3.542z" />
    ...
    <Path d="M117.295 427.001c-22.765-136.585-.23-272.673 0-274.032l2.267.384c-.23 1.356-22.698 137.077 0 273.27z" fill={props.accentcolor} />
    <Path fill={props.accentcolor} d="M110.115 240.623l51.468-27.53 1.084 2.028-51.468 27.53zM55.797 228.912l1.086-2.028 51.46 27.544-1.085 2.027z" />
    <Ellipse cx={245.754} cy={167.201} rx={77.883} ry={158.914} fill={props.primarycolor} />
    <Path d="M254.847 427.001c-31.14-186.837-.315-372.992 0-374.85l2.267.384c-.314 1.854-31.073 187.643 0 374.089z" fill={props.accentcolor} />
    <Path
      fill={props.accentcolor}
