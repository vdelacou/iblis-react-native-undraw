...
export const SvgImageFolder = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 729.47 695.09" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="ImageFolder_svg__a" x1={611.98} y1={687.2} x2={611.98} y2={258.73} gradientUnits="userSpaceOnUse">
      ...
      />
      <LinearGradient id="ImageFolder_svg__d" x1={597.01} y1={453.03} x2={597.01} y2={138.64} gradientTransform="rotate(20.42 597.09 295.9)" xlinkHref="#ImageFolder_svg__a" />
      <LinearGradient
        ...
        xlinkHref="#ImageFolder_svg__a"
      />
      <LinearGradient id="ImageFolder_svg__f" x1={310} y1={695.09} x2={310} y2={203.86} xlinkHref="#ImageFolder_svg__a" />
      <LinearGradient id="ImageFolder_svg__b" x1={545.79} y1={695.81} x2={545.79} y2={464.64} gradientUnits="userSpaceOnUse">
      ...
      <LinearGradient id="ImageFolder_svg__g" x1={310.8} y1={580.62} x2={310.8} y2={375.85} xlinkHref="#ImageFolder_svg__b" />
      <ClipPath id="ImageFolder_svg__h" transform="translate(-235.26 -102.45)">
        <Rect x={400.07} y={483.3} width={291.69} height={194.01} rx={8.85} ry={8.85} fill="#fff" />
      </ClipPath>
    </Defs>
    <Path fill="url(#ImageFolder_svg__a)" d="M618.97 687.2H513.53V258.73h196.89L618.97 687.2z" />
    <Path fill="#f5f5f5" d="M613.72 687.2H510.37V258.73h192.98L613.72 687.2z" />
    <Path transform="rotate(-15.62 -21.728 1049.253)" fill="url(#ImageFolder_svg__c)" d="M249.88 158.45h439.19V327.3H249.88z" />
    ...
    <Path fill="#fff" d="M142.457 174.853l104.637-29.255 2.232 7.984-104.637 29.254zM137.988 158.89l168.152-47.013 2.232 7.984-168.152 47.012z" />
    <Circle cx={329.58} cy={277.88} r={19.34} transform="rotate(-15.62 -161.6 1084.217)" fill="#fff" />
    <Path transform="rotate(-20.42 195.057 897.759)" fill="url(#ImageFolder_svg__d)" d="M376.38 210.25h441.26v171.17H376.38z" />
    ...
    <Path fill="#fff" d="M272.41 236.686l101.823-37.908 2.893 7.77-101.823 37.907zM268.356 221.441l164.125-61.11 2.901 7.793-164.124 61.11z" />
    <Circle cx={459.76} cy={343.69} r={19.34} transform="rotate(-20.42 57.805 945.61)" fill="#fff" />
    <Path transform="rotate(-79.9 554.185 460.16)" fill="url(#ImageFolder_svg__e)" d="M646.89 150.88h172.17v440.14H646.89z" />
    ...
    <Path fill="#fff" d="M396.49 266.991l1.453-8.161 106.966 19.054-1.454 8.161zM399.386 250.67l1.454-8.162 171.894 30.619-1.454 8.161z" />
    <Circle cx={589.6} cy={340.88} r={19.34} transform="rotate(-79.9 410.809 430.091)" fill="#fff" />
    <Path fill="url(#ImageFolder_svg__f)" d="M171.78 253.69l-71.17-49.83H2.07v491.23h615.86v-441.4H171.78z" />
    ...
    />
    <Path d="M472.55 582.55a7 7 0 01-7 7H155.79a7 7 0 01-7-7V373.17a7 7 0 017-7h309.72a7 7 0 017 7" fill="#fff" />
    <Rect x={161.12} y={375.85} width={299.37} height={204.76} rx={8.85} ry={8.85} fill="url(#ImageFolder_svg__g)" data-name="&lt;Rectangle&gt;" />
