...
export const SvgSmartwatch = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 849 824.98" style={props.style} width="100%" height={props.height} {...props}>
    <Path d="M701 477.99l21-7 8 13-5.018 6.759A22.538 22.538 0 01703 487.99c-11-8-2-10-2-10z" fill="#9f616a" />
    <Path d="M662 305a34 34 0 00-34 34v35h8.02l1.271-3.449.974 3.45h48.755l1.271-3.45.974 3.45H696V339a34 34 0 00-34-34z" fill={props.haircolor} />
    <Path
      ...
      fill="#9f616a"
    />
    <Path d="M649.278 355.577s-5.337 28.973-9.912 29.735 19.062 9.15 19.062 9.15l19.06-1.525-2.287-6.1s-6.1-15.249 0-29.735-25.923-1.525-25.923-1.525z" opacity={0.1} />
    <Path
    ...
    <Path d="M713.705 474.9l.762.762-44.603-5.718s-22.492-7.244-28.591 7.243 31.641 8.005 31.641 8.005 47.272 12.962 56.42 3.05a4.387 4.387 0 00.588-.841z" fill="#9f616a" />
    ...
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M356.808 337.81l.253-55.795" />
    ...
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M442.66 311.362l1.771-113.59" />
    ...
    <Path d="M442.694 309.193s5.798-46.536-23.47-49.247" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={419.224} cy={259.946} r={7.89} fill={props.accentcolor} />
    <Circle cx={171.213} cy={128.011} r={30.759} fill={props.primarycolor} />
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M171.232 314.234v-186.11" />
    <Circle cx={171.232} cy={128.035} r={7.89} fill={props.accentcolor} />
    <Circle cx={146.998} cy={262.687} r={7.89} fill={props.accentcolor} />
    <Path d="M171.232 168.34s-1.127-24.244-24.234-21.426M171.232 237.068s-1.127-24.244-24.234-21.426" fill={props.accentcolor} />
    <Path d="M171.232 312.065s5.073-47.123-24.234-49.378" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={195.951} cy={188.672} r={7.89} fill={props.accentcolor} />
    <Path d="M171.717 235.537s-5.073-44.61 24.234-46.865" fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Path
    ...
    <Path fill={props.primarycolor} d="M299.732 258.58v55.359l-29.89 16.839-60.62-4.631v-57.253l30.099-10.314h60.411z" />
    ...
    <Path fill={props.accentcolor} stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} d="M810.582 824.98V708.887" />
    ...
    <Circle cx={221.117} cy={625.378} r={14.756} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
    <Circle cx={348.383} cy={625.378} r={14.756} fill="none" stroke={props.accentcolor} strokeMiterlimit={10} strokeWidth={2} />
  </Svg>
);
