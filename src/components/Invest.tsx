...
export const SvgInvest = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 1106 776" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path d="M370 155s1 26-5 32 30 27 30 27l21-33s-8-14-6-26zM305.5 683.5v25l31 2-2-27h-29zM475.5 683.5v25l-31 2 2-27h29z" fill="#a0616a" />
    <Path
    ...
    <Path
      ...
      fill={props.accentcolor}
    />
    <Path d="M311.5 282.5l-4 31s-16 33-12 77l-1 29s-10 50 10 52 7-55 7-55l11-27 11.26-60.062 5.74-41.938z" fill="#a0616a" />
