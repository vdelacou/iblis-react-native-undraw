...
export const SvgStatisticChart = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 885.528 664.187" style={props.style} width="100%" height={props.height} {...props}>
    ...
    <Path fill={props.accentcolor} d="M320.375 305.854l91.474-160.289H228.803l-91.571 158.606 91.571 158.607h183.143l91.401-158.31-182.972 1.386z" />
    <Path fill={props.primarycolor} d="M526.065 291.005l.171-.297-91.571-158.606h-.098l-91.474 160.289 182.972-1.386z" />
    <Path
