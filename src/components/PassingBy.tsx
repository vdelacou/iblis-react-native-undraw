...
export const SvgPassingBy = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 662.59 772.47" style={props.style} width="100%" height={props.height} {...props}>
    <Defs>
      <LinearGradient id="PassingBy_svg__a" x1={712.84} y1={780.83} x2={712.84} y2={63.76} gradientUnits="userSpaceOnUse">
        <Stop offset={0} stopColor="gray" stopOpacity={0.25} />
        <Stop offset={0.54} stopColor="gray" stopOpacity={0.12} />
        <Stop offset={1} stopColor="gray" stopOpacity={0.1} />
      </LinearGradient>
      <LinearGradient id="PassingBy_svg__b" x1={823.89} y1={836.24} x2={823.89} y2={792.92} xlinkHref="#PassingBy_svg__a" />
      <LinearGradient id="PassingBy_svg__c" x1={765.44} y1={798.81} x2={774.59} y2={798.81} xlinkHref="#PassingBy_svg__a" />
      <LinearGradient id="PassingBy_svg__d" x1={773.04} y1={819.89} x2={782.68} y2={819.89} xlinkHref="#PassingBy_svg__a" />
      <LinearGradient id="PassingBy_svg__e" x1={841.4} y1={774.77} x2={857.03} y2={774.77} xlinkHref="#PassingBy_svg__a" />
      <LinearGradient id="PassingBy_svg__f" x1={813.5} y1={743.8} x2={827.3} y2={743.8} xlinkHref="#PassingBy_svg__a" />
      <LinearGradient id="PassingBy_svg__g" x1={547.19} y1={827.61} x2={547.19} y2={401.38} xlinkHref="#PassingBy_svg__a" />
    </Defs>
    <Path
    ...
    <G data-name="&lt;Group&gt;">
      <G data-name="&lt;Group&gt;">
        ...
        <Rect data-name="&lt;Rectangle&gt;" x={638.93} y={489.89} width={40.02} height={180.1} rx={18} ry={18} transform="matrix(.98 -.17 .17 .98 -359.62 59.83)" fill="#f59295" />
      ...
      <Rect data-name="&lt;Rectangle&gt;" x={139.8} y={526.28} width={40.02} height={180.1} rx={18} ry={18} fill="#f59295" />
      ...
      <Rect data-name="&lt;Rectangle&gt;" x={346.58} y={550.73} width={40.02} height={180.1} rx={18} ry={18} fill="#f2777a" />
      <Ellipse data-name="&lt;Path&gt;" cx={354.92} cy={715.82} rx={35.02} ry={25.01} fill="#fbd5cc" />
      <Rect data-name="&lt;Rectangle&gt;" x={169.82} y={540.73} width={40.02} height={180.1} rx={18} ry={18} fill="#f2777a" />
