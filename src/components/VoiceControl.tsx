...
export const SvgVoiceControl = (props: IIblisReactNativeUndrawProps & SvgProps) => (
  <Svg data-name="Layer 1" viewBox="0 0 972.57 830.55" style={props.style} width="100%" height={props.height} {...props}>
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M385.87 279.38v117.57a52.62 52.62 0 0052.66 52.65h70.2a47.27 47.27 0 0047.3-47.33V279.38a85.08 85.08 0 00-170.16 0z" fill="#65617d" />
    <Path d="M385.87 279.38v117.57a52.62 52.62 0 0052.66 52.65h70.2a47.27 47.27 0 0047.3-47.33V279.38a85.08 85.08 0 00-170.16 0z" opacity={0.1} />
    <Path d="M388.4 280.64v114.08a51.06 51.06 0 0051.09 51.08h68.12a45.86 45.86 0 0045.89-45.88V280.64a82.55 82.55 0 00-165.1 0z" fill="#65617d" />
    <Path
    ...
    <Path d="M478.68 600.33l85.19 42a21.56 21.56 0 0112 19.35v1.27l-99.5-43.38-14-1-82.74 52.83a21.58 21.58 0 018.91-20.49l73.83-52.28z" fill="#333f4f" />
    ...
    <Path
      ...
      fill="#333f4f"
    />
    <Path d="M540.8 574.56s11.37 11.64 19.13 12.75 14.14 26.06 3.33 28-31.61-5.82-34.66-9.15-14.14-23-14.14-23z" fill="#65617d" />
    <Path
    ...
    <Path
      ...
      fill="#fbbebe"
    />
    <Path d="M463.58 287.88c.3.35.61.68.92 1a33.25 33.25 0 0045.28 2.88c-.38-7.34-.31-13.05-.31-13.05s-49.63-17.75-45.19-5.55c1.61 4.45.88 9.76-.7 14.72z" opacity={0.1} />
    <Path d="M455.41 264.95a33.26 33.26 0 1033.27-33.27 33.06 33.06 0 00-33.27 33.27z" fill="#fbbebe" />
    <Path d="M496.44 335.61s13-28.88 17.47-28.88 11.38 149.39 11.38 149.39l-67.92 1.06-2.78-78.43 13.85-69.48s12.47 27.41 28 26.34z" opacity={0.1} />
    <Path d="M496.44 337.83s13-28.88 17.47-28.88 11.38 149.38 11.38 149.38l-77.07 1.17 6.37-78.53 13.87-69.53s12.45 27.46 27.98 26.39z" opacity={0.1} />
    <Path d="M496.44 336.72s13-28.88 17.47-28.88 11.38 149.43 11.38 149.43l-77.07 1.17 6.37-78.53 13.87-69.53s12.45 27.41 27.98 26.34z" fill="#65617d" />
    <Path
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M222.36 706.27l19 64.5 43 42 54 11 84-15v-298.5s-14.5-9.5-16-9.5-42 6.5-42 6.5l-91.7 65.77-3.8 2.73-41 61z" fill="#65617d" />
    <Path fill="#65617d" d="M422.36 497.81v311l-8.1 1.45V497.81h8.1z" />
    <Path opacity={0.1} d="M798.36 464.31l-138 3V632.5l131 88.81 31.5-29-6.5-96 6.5-89.5-24.5-42.5zM422.36 497.81v311l-8.1 1.45V497.81h8.1z" />
    <Path d="M270.86 593.81c60-49.3 126.7-56.55 151.5-57.45v-26.09s-14.5-9.5-16-9.5-42 6.5-42 6.5l-91.7 65.77z" opacity={0.1} />
    <Path
    ...
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M598.87 316.59v110.93c0 1.91-1 2.18-2.69 3.11-5.62 3.12-19.49 8.67-36.13-.12-1.71-.9-2.76-1.21-2.76-3.14v-110.1s21.15 8.56 41.58-.68z" fill="#333f4f" />
    ...
    <Path d="M124.15 689.52s7.13 9.33-3.29 23.41-19 26-15.55 34.76c0 0 15.73-26.16 28.54-26.52s4.44-15.9-9.7-31.65z" fill={props.primarycolor} />
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M137.41 701.41c0 3.28-.37 5.94-.82 5.94s-.82-2.66-.82-5.94.46-1.74.91-1.74.73-1.55.73 1.74z" fill="#ffd037" />
    <Path d="M141.96 705.33c-2.88 1.57-5.39 2.52-5.61 2.12s1.94-2 4.83-3.57 1.74-.43 2 0 1.67-.12-1.22 1.45z" fill="#ffd037" />
    <Path d="M86.46 689.52s-7.13 9.33 3.29 23.41 19 26 15.56 34.76c0 0-15.74-26.16-28.54-26.52s-4.4-15.9 9.69-31.65z" fill={props.primarycolor} />
    <Path
      ...
      opacity={0.1}
    />
    <Path d="M73.2 701.41c0 3.28.37 5.94.82 5.94s.82-2.66.82-5.94-.46-1.74-.91-1.74-.73-1.55-.73 1.74z" fill="#ffd037" />
    <Path d="M68.65 705.33c2.88 1.57 5.39 2.52 5.61 2.12s-1.94-2-4.83-3.57-1.74-.43-2 0-1.67-.12 1.22 1.45z" fill="#ffd037" />
    <Ellipse cx={219.02} cy={842.35} rx={74.6} ry={11.45} transform="rotate(-4.05 -328.604 2434.047)" fill={props.primarycolor} opacity={0.1} />
    <Path
      ...
      fill="#65617d"
    />
    <Path fill="#9d9cb5" d="M143.34 738.04l-.5 4.11H67.76l-.5-4.11h76.08zM142.63 743.87l-.5 4.12H68.48l-.51-4.12h74.66zM141.91 749.7l-.5 4.11H69.19l-.5-4.11h73.22z" />
    ...
    <Path d="M779.94 414.01l-3.54.75-.35.07s-9.44-7.66-9.32-24.76a42.22 42.22 0 004.51 7.13c3.74 4.95 7.99 11.56 8.7 16.81z" fill={props.primarycolor} />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M796.91 390.07c.12 17.1-12.14 24.76-12.14 24.76l-.36-.07-3.53-.75c.7-5.25 5-11.86 8.69-16.81a38.47 38.47 0 017.34-7.13z" fill={props.primarycolor} />
    <Path
    ...
    <Path d="M779.94 414.01l-3.54.75-.35.07s-9.44-7.66-9.32-24.76a42.22 42.22 0 004.51 7.13c3.74 4.95 7.99 11.56 8.7 16.81z" opacity={0.1} />
    <Path
      d="M781.13 415.65a2.22 2.22 0 01-1.9.24c-9.08-2.12-6-31.71-6-31.71.5.24 1.05 4 3.14 8.86 3.65 8.54 7.68 20.46 4.76 22.61zM801.29 398.09s.59 15.92-14.62 17.8l-.94-1.76s14.56-11.09 15.56-16.04z"
      opacity={0.1}
    />
    <Path d="M796.91 390.07c.12 17.1-12.14 24.76-12.14 24.76l-.36-.07-3.53-.75c.7-5.25 5-11.86 8.69-16.81a38.47 38.47 0 017.34-7.13z" opacity={0.1} />
    <Path
      d="M784.36 414.1a5.74 5.74 0 01-2 1.55 3.86 3.86 0 01-.75.24c-2.23.53-3-1.09-2.88-3.82.21-4.88 3.27-13.33 6-19.65a24.53 24.53 0 015.7-8.24s-.14 23.09-6.07 29.92z"
      opacity={0.1}
    />
    ...
    <Path d="M781.35 414.01l-3.54.75-.35.07s-10.85-7.66-10.73-24.76c0 0 2.78 3 5.92 7.13 3.74 4.95 7.99 11.56 8.7 16.81z" fill={props.primarycolor} />
    ...
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M796.91 390.07c.12 17.1-10.73 24.76-10.73 24.76l-.35-.07-3.54-.75c.7-5.25 5-11.86 8.7-16.81 3.14-4.15 5.92-7.13 5.92-7.13z" fill={props.primarycolor} />
    <Path d="M790.99 397.2c-.46 6.46-1.64 13.57-4.51 16.9a6.77 6.77 0 01-.65.66l-3.54-.75c.7-5.25 5-11.86 8.7-16.81z" opacity={0.1} />
    <Path
      ...
      fill={props.primarycolor}
    />
    <Path d="M782.55 415.65a2.55 2.55 0 01-1.44-.46c-4.27-2.66-4.36-12.65-3.34-22.15 3.67 8.54 7.69 20.46 4.78 22.61z" opacity={0.1} />
    <Path d="M785.77 414.1c-.49 1.06-1.15 1.62-2 1.55a3 3 0 01-1.21-.46 6.55 6.55 0 01-2.42-3.12c.22-4.88 3.28-13.33 6-19.65.98 8.77 1.31 18.08-.37 21.68z" opacity={0.1} />
